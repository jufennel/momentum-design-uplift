  ...
  <div className="wrapper">
    <div className="banner">
      <div className="illustrationWrapper">
        <img src={`${import.meta.env.BASE_URL}header-illustration.svg`} className="heroIllustration" />
        <img src={`${import.meta.env.BASE_URL}hero-gradient.svg`} className="heroGradient" />
      </div>
