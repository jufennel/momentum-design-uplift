import{ac as e}from"./iframe-2vtXQJPx.js";import{useMDXComponents as t}from"./index-BN0FTCSF.js";import"./preload-helper-C1FmrZbK.js";function o(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"installation",children:"Installation"}),`
...
`,e.jsx(n.a,{href:"https://momentum-design.github.io/momentum-design/storybook-static/index.html?path=/docs/providers-motion-provider--docs",rel:"nofollow",children:e.jsx(n.strong,{children:"Motion Provider"})}),`
(when using token-based motion),
...
components. Use `,e.jsx(n.code,{children:"mdc-motionprovider"})," to scope ",e.jsx(n.code,{children:"mds-motion"})," and ",e.jsx(n.code,{children:"mds-animation"}),`
on its host — do not duplicate those classes on `,e.jsx(n.code,{children:"<body>"}),` when the motion
provider is present.`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
