import{N as C,k as c}from"./iframe-2vtXQJPx.js";import{c as _,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as P,a as q}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,W=t=>c` <div role="main">
    <mdc-radiogroup
      name="${t.name}"
      label="${t.label}"
  ...
  </div>`,I={title:"Components/radiogroup",tags:["autodocs"],component:"mdc-radiogroup",render:W,argTypes:{..._,...E,name:{control:{type:"text"}},label:{control:{type:"text"}},"help-text":{control:{type:"text"}},"help-text-type":{control:"select",options:Object.values(C)},required:{control:"boolean"},...P(["disabled","info-icon-aria-label","isRadio",'Slot Name: "toggletip"',"toggletip-placement","toggletip-strategy","toggletip-text"])}},n={args:{label:"Select your team captain","help-text":"The team captain should have previous experience leading the team through challenging situations.","help-text-type":C.DEFAULT,name:"team-captain-with-experience",required:!0}},i={args:{label:"Select your team captain","help-text":"The team captain should have previous experience leading the team through challenging situations.",name:"team-captain-with-experience"}},l={args:{label:"Select your team captain",name:"team-captain"}},s=()=>{const t=a=>{const e=a.querySelector('mdc-radiogroup[name="course-plan"]');return Array.from(a.querySelectorAll('mdc-radio[name="course-plan"]')).find(D=>D.checked)?(e==null||e.setAttribute("help-text","Looks good!"),e==null||e.setAttribute("help-text-type","success"),!0):(e==null||e.setAttribute("help-text","Please select a course plan"),e==null||e.setAttribute("help-text-type","error"),!1)};return c`
    <form @submit=${a=>{a.preventDefault();const e=a.target;if(!t(e))return;const u=new FormData(e).get("course-plan");O("Form Submitted")({name:"course-plan",value:u})}} @reset=${a=>{const r=a.target.querySelector('mdc-radiogroup[name="course-plan"]');r==null||r.setAttribute("help-text","Choose a plan that best suits your needs"),r==null||r.setAttribute("help-text-type","default")}} novalidate>
      <div role="main">
        <mdc-radiogroup
          name="course-plan"
  ...
  `},d={render:()=>{let t="medium";const m=o=>{t=o.target.value};return c`
      <style>
      ...
      <main>
        ...
        <mdc-radiogroup class="skinTonePickerWrapper" name="skin-tone-picker">
          ${["yellow","light","medium_light","medium","medium_dark","dark"].map(o=>c` <mdc-radio ?checked="${o===t}" onChange="${m}" class="skinToneOption">
                <mdc-animation
    ...
    `},...q()};var p,h,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
  ...
  \`;
}`,...(A=(T=s.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var R,$,w;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(w=($=d.parameters)==null?void 0:$.docs)==null?void 0:w.source}}};const H=["Example","RadioGroupWithDescription","RadioGroupWithoutDescription","RadioGroupInFormWithHelpTextValidation","RadioGroupWithCustomRadioSlot"];export{n as Example,s as RadioGroupInFormWithHelpTextValidation,d as RadioGroupWithCustomRadioSlot,i as RadioGroupWithDescription,l as RadioGroupWithoutDescription,H as __namedExportsOrder,I as default};
