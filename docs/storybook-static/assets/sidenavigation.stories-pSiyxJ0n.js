import{ay as S,az as M,aA as d,k as a}from"./iframe-Bzl5oY3a.js";import{c as N,s as f}from"./commonArgTypes-BG7EqI50.js";import{h as T}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,C=e=>a`
...
`,A=e=>{const w=()=>{window.confirm("Are you sure you want to cancel?")};return a` <div style="height: 90vh; margin: 1rem">
    <mdc-sidenavigation
      variant="${e.variant}"
      footer-text=${e["footer-text"]}
      grabber-btn-aria-label="${e["grabber-btn-aria-label"]}"
...
`,_={title:"Components/sidenavigation/sidenavigation",tags:["autodocs"],component:"mdc-sidenavigation",render:C,argTypes:{expanded:{control:"boolean"},variant:{control:"select",options:Object.values(S)},"grabber-btn-aria-label":{control:"text"},"hide-fixed-section-divider":{control:"boolean"},"submenu-type":{control:"select",options:Object.values(M)},...T(["Context"]),...N,...f}},t={args:{expanded:!0,variant:d.VARIANT,"submenu-type":d.SUBMENU_TYPE,"footer-text":"%Customer Name%","grabber-btn-aria-label":"Toggle Side navigation"}},i={render:$,parameters:{docs:{description:{story:a`<mdc-text tagname="span" style="margin-bottom: 0.5rem;">
          ...
          ></mdc-banner> `}}},args:{expanded:!0,variant:d.VARIANT,"submenu-type":d.SUBMENU_TYPE,"footer-text":"%Customer Name%","grabber-btn-aria-label":"Toggle Side navigation","hide-fixed-section-divider":!0}},m={render:A,args:{...t.args}},o={render:I,parameters:{docs:{description:{story:a`<mdc-text tagname="span" style="margin-bottom: 0.5rem;">
          ...
          <br />
        </mdc-text>`}}},args:{...t.args,"submenu-type":M.DROPDOWN}};var c,l,s;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    expanded: true,
...
}`,...(s=(l=t.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};var r,u,v;i.parameters={...i.parameters,docs:{...(r=i.parameters)==null?void 0:r.docs,source:{originalSource:`{
...
}`,...(y=(h=o.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};const O=["Example","Mixed","NestedSideNavigation","DropdownSideNavigation"];export{o as DropdownSideNavigation,t as Example,i as Mixed,m as NestedSideNavigation,O as __namedExportsOrder,_ as default};
