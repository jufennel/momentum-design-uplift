import{W as e,k as n,R as A,t as a}from"./iframe-DLRyxUrR.js";import{i as g}from"./manifest-CNQCgfOm.js";import{c as C,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as T,a as k}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,S=o=>n` <mdc-chip
    @click="${l("onclick")}"
    @keydown="${l("onkeydown")}"
    @keyup="${l("onkeyup")}"
    @focus="${l("onfocus")}"
