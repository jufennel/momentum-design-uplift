import{bj as O,b9 as ne,k as t,Q as ie}from"./iframe-2vtXQJPx.js";import{b as ae,a as c}from"./utils-B5QUENNQ.js";import{c as ce,s as re}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";var de=Object.defineProperty,L=(e,o,l,i)=>{for(var a=void 0,d=e.length-1,A;d>=0;d--)(A=e[d])&&(a=A(o,l,a)||a);return a&&de(o,l,a),a};class f extends ne{constructor(){super(),this.listItems=new Array(1e3).fill(!0),this.virtualData={virtualItems:[]},this.virtualizerProps={count:0,estimateSize:()=>0,getItemKey:o=>this.listItems[o]},this.handleVirtualItemsChange=o=>{this.virtualData=o.detail},this.onscroll=null}connectedCallback(){super.connectedCallback(),this.updateVirtualProps()}updateVirtualProps(){this.virtualizerProps={count:this.listItems.length,estimateSize:()=>36,getItemKey:o=>this.listItems[o]}}render(){return t`
      <div class="wrapper">
        <mdc-virtualizedlist
