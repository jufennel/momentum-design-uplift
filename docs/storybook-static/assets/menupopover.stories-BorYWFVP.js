import{L as a,X as p,k as t,am as L}from"./iframe-CmSvbQSS.js";import{c as ue,s as se}from"./commonArgTypes-BG7EqI50.js";import{h as ge}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,i=(e,r=t``)=>t`
  <mdc-menupopover
    id="${e.id}"
...
`,pe=t` <mdc-menuitem label="Profile"></mdc-menuitem>
  ...
  <mdc-menupopover triggerID="submenu-trigger" placement="right">
    ...
    <mdc-menuitem label="Security" id="security-id" arrow-position="trailing"></mdc-menuitem>
    <mdc-menuitem label="Advanced"></mdc-menuitem>
  </mdc-menupopover>`,n={args:{id:"popover",triggerID:"popover-trigger",placement:a.BOTTOM_START,offset:p.OFFSET,"z-index":p.Z_INDEX,delay:p.DELAY,"disable-flip":p.DISABLE_FLIP,"disable-aria-expanded":!1},render:e=>t`
    <mdc-menuitem id="popover-trigger" label="File"></mdc-menuitem>
    ${i(e,l)}
  `},b={args:{...n.args,triggerID:"button-trigger"},render:e=>t`
    <mdc-button id="button-trigger">Menu</mdc-button>
    ${i(e,l)}
  `},v={args:{...n.args,triggerID:"icon-trigger"},render:e=>t`
    <mdc-button prefix-icon="placeholder-bold" id="icon-trigger" aria-label="Icon Button"></mdc-button>
    ${i(e,l)}
  `},h={args:{...n.args,triggerID:"button-group-trigger"},render:e=>t`
    ...
    ${i(e,l)}
  `},y={args:{...n.args,placement:a.RIGHT_START,triggerID:"trigger-btn"},render:e=>t`
    <div id="menupopover-test-wrapper">
      <mdc-button id="trigger-btn">Options</mdc-button>
      ${i(e,pe)}
    </div>
  `},f={args:{...n.args,placement:a.RIGHT_END,triggerID:"trigger-btn"},render:e=>t`
    <div
  ...
  `},k={args:{...n.args,placement:a.RIGHT_END,triggerID:"trigger-btn"},render:e=>t`
    <div
      id="menupopover-test-wrapper"
      style="display: flex; justify-content: flex-start; align-items: center; height: 100%;"
    >
  ...
  `},x={args:{...n.args,triggerID:"button-trigger"},render:e=>t`
    <mdc-button id="button-trigger">Menu</mdc-button>
  ...
  `},I={args:{...n.args,triggerID:"button-trigger"},render:e=>t` <mdc-list>
      ...
      ${i(e,l)}`},S={args:{...n.args,triggerID:"button-trigger"},render:()=>{let e=1;const r=o=>o.key===L.ENTER||o.key===L.SPACE?o.stopPropagation():void 0,u=o=>{var D,A;o.stopImmediatePropagation();const E=((D=o.target)==null?void 0:D.getAttribute("name"))==="delay",d=(A=o.target)==null?void 0:A.closest("mdc-menupopover"),c=document.createElement("mdc-menuitem");c.setAttribute("label",`#${e} Remove itself ${E?"with delay":""}`),c.addEventListener("click",$=>{var s,T;$.stopPropagation(),E?setTimeout(()=>{var g,M;return(M=(g=$.target)==null?void 0:g.remove)==null?void 0:M.call(g)},500):(T=(s=$.target)==null?void 0:s.remove)==null||T.call(s)}),c.addEventListener("keydown",r),E?setTimeout(()=>d==null?void 0:d.append(c),500):d==null||d.append(c),e+=1};return t`<mdc-button id="trigger-btn">Dynamic menu</mdc-button>
      <mdc-menupopover triggerID="trigger-btn" placement="bottom-start">
        ...
        <mdc-divider></mdc-divider>
      </mdc-menupopover>`}};var P,O,N;n.parameters={...n.parameters,docs:{...(P=n.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    id: 'popover',
  ...
  \`
}`,...(N=(O=n.parameters)==null?void 0:O.docs)==null?void 0:N.source}}};var C,z,_;b.parameters={...b.parameters,docs:{...(C=b.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(j=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:j.source}}};var H,Y,K;f.parameters={...f.parameters,docs:{...(H=f.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(K=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:K.source}}};var X,q,Q;k.parameters={...k.parameters,docs:{...(X=k.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    placement: POPOVER_PLACEMENT.RIGHT_END,
    triggerID: 'trigger-btn'
  ...
  \`
}`,...(Q=(q=k.parameters)==null?void 0:q.docs)==null?void 0:Q.source}}};var J,ee,te;w.parameters={...w.parameters,docs:{...(J=w.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; justify-content: space-between; width: 10rem;">
      <mdc-button id="file-menu-trigger">File</mdc-button>
      <mdc-menupopover triggerid="file-menu-trigger" backdrop>
  ...
  \`
}`,...(te=(ee=w.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ne,me,ie;x.parameters={...x.parameters,docs:{...(ne=x.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    triggerID: 'button-trigger'
  },
  render: args => html\`
    ...
    \${createPopover(args, html\` <mdc-menusection headerText="Layout" class="layout-section">
        ...
        <mdc-menuitem id="notification-menu-item" label="Notifications"></mdc-menuitem>\`)}
  \`
}`,...(ie=(me=x.parameters)==null?void 0:me.docs)==null?void 0:ie.source}}};var re,oe,de;I.parameters={...I.parameters,docs:{...(re=I.parameters)==null?void 0:re.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    triggerID: 'button-trigger'
  },
...
}`,...(le=(ae=S.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};const xe=["Example","ButtonTrigger","IconTrigger","ButtonGroupTrigger","WithGroups","WithNestedSubmenus","WithNestedSubmenuContentAndSelectMenuItems","MixedUsage","CustomMenu","MenuInList","DynamicMenu"];export{h as ButtonGroupTrigger,b as ButtonTrigger,x as CustomMenu,S as DynamicMenu,n as Example,v as IconTrigger,I as MenuInList,w as MixedUsage,y as WithGroups,k as WithNestedSubmenuContentAndSelectMenuItems,f as WithNestedSubmenus,xe as __namedExportsOrder,we as default};
