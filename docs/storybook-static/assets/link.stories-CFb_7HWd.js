import{a8 as E,k as c,a9 as z}from"./iframe-CmSvbQSS.js";import{h as s,r as p}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,C=e=>c`<mdc-link
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
