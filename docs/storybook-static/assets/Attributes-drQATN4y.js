import{ac as e}from"./iframe-CmSvbQSS.js";import{useMDXComponents as t}from"./index-B0Euo4Cd.js";import"./preload-helper-C1FmrZbK.js";function i(s){const n={a:"a",br:"br",code:"code",h1:"h1",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"common-attributes",children:"Common Attributes"}),`
...
`,e.jsxs(n.p,{children:[`Three state attributes provide different levels of interactivity, accessibility,
and intent.`,e.jsx(n.br,{}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Interactions"}),`: Content is visible but cannot be edited. Users can still
focus the field.`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Interactions"}),`: No interaction at all (not focusable, not editable, not
selectable)`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Focusable"}),": ✅ Yes"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Visual styles"}),": Dimmed/grayed out"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Interactions"}),`: Focusable, but editing is blocked. Can display a tooltip or
helper text to explain why.`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Screen Reader"}),": Fully accessible"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Events"}),`: When using soft disabled, consumers must ensure that the element behaves like a
...
`,e.jsx(n.li,{children:`Users need to understand why the field is unavailable (e.g., “Upgrade plan
to enable”).`}),`
...
autofocus`}),"."]}),`
`,e.jsx(n.hr,{}),`
`,e.jsxs(n.h3,{id:"control-type-attribute",children:[e.jsx(n.code,{children:"control-type"})," Attribute"]}),`
`,e.jsxs(n.p,{children:["This attribute can be set to ",e.jsx(n.code,{children:"controlled"})," or ",e.jsx(n.code,{children:"uncontrolled"})]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"controlled"}),` components should be used if your application is expecting to
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"uncontrolled"}),` components should be used if your application is expecting the
...
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["Components using the ",e.jsx(n.code,{children:"ControlTypeMixin"})," default to ",e.jsx(n.code,{children:"uncontrolled"}),`, but this
default can be changed by using a `,e.jsx(n.code,{children:"ControlTypeProvider"}),` with attribute
`,e.jsx(n.code,{children:'controlType="controlled"'})]})]})}function c(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{c as default};
