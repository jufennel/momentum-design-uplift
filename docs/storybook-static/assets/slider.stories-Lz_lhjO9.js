import{k as B}from"./iframe-DttjxJGb.js";import{c as K,s as L}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:u}=__STORYBOOK_MODULE_ACTIONS__,N=e=>B`
  <mdc-slider
    @input="${u("input")}"
    @change="${u("change")}"
    min="${e.min}"
