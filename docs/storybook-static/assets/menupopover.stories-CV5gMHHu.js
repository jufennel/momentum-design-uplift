import{M as a,Y as p,k as t,an as P}from"./iframe-Ctm5TQtB.js";import{c as ue,s as se}from"./commonArgTypes-BG7EqI50.js";import{h as ge}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,i=(e,r=t``)=>t`
  <mdc-menupopover
    id="${e.id}"
...
`,pe=t` <mdc-menuitem label="Profile"></mdc-menuitem>
  ...
  `},I={args:{...n.args,triggerID:"button-trigger"},render:e=>t` <mdc-list>
      ...
      ${i(e,l)}`},S={args:{...n.args,triggerID:"button-trigger"},render:()=>{let e=1;const r=o=>o.key===P.ENTER||o.key===P.SPACE?o.stopPropagation():void 0,u=o=>{var D,A;o.stopImmediatePropagation();const E=((D=o.target)==null?void 0:D.getAttribute("name"))==="delay",d=(A=o.target)==null?void 0:A.closest("mdc-menupopover"),c=document.createElement("mdc-menuitem");c.setAttribute("label",`#${e} Remove itself ${E?"with delay":""}`),c.addEventListener("click",$=>{var s,T;$.stopPropagation(),E?setTimeout(()=>{var g,M;return(M=(g=$.target)==null?void 0:g.remove)==null?void 0:M.call(g)},500):(T=(s=$.target)==null?void 0:s.remove)==null||T.call(s)}),c.addEventListener("keydown",r),E?setTimeout(()=>d==null?void 0:d.append(c),500):d==null||d.append(c),e+=1};return t`<mdc-button id="trigger-btn">Dynamic menu</mdc-button>
      <mdc-menupopover triggerID="trigger-btn" placement="bottom-start">
        ...
        <mdc-divider></mdc-divider>
      </mdc-menupopover>`}};var L,O,N;n.parameters={...n.parameters,docs:{...(L=n.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    id: 'popover',
  ...
  \`
}`,...(K=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:K.source}}};var q,Q,X;k.parameters={...k.parameters,docs:{...(q=k.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    placement: POPOVER_PLACEMENT.RIGHT_END,
    triggerID: 'trigger-btn'
  ...
  \`
}`,...(X=(Q=k.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var J,ee,te;w.parameters={...w.parameters,docs:{...(J=w.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; justify-content: space-between; width: 10rem;">
      <mdc-button id="file-menu-trigger">File</mdc-button>
      <mdc-menupopover triggerid="file-menu-trigger" backdrop>
