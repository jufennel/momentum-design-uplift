import{U as R,M as k,N as I,k as h,t as s}from"./iframe-Cu7nV89y.js";import{c as L,s as C}from"./commonArgTypes-BG7EqI50.js";import{h as M}from"./utils-B5QUENNQ.js";import"./preload-helper-DvzR3F7X.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,z=e=>{const l=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return h` <mdc-password
    @input="${o("oninput")}"
    @change="${o("onchange")}"
    @focus="${o("onfocus")}"
    @blur="${o("onblur")}"
