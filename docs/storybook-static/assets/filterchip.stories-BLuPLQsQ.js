import{k as _}from"./iframe-CmSvbQSS.js";import{c as x,s as A}from"./commonArgTypes-BG7EqI50.js";import{h as D}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,$=t=>_` <mdc-filterchip
    @click="${e("onclick")}"
    @keydown="${e("onkeydown")}"
    @keyup="${e("onkeyup")}"
    @focus="${e("onfocus")}"
