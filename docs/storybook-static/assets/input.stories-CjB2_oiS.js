import{U as V,a8 as _,M as R,N as W,k as i,t as a}from"./iframe-BRzdycIC.js";import{c as j,s as k}from"./commonArgTypes-BG7EqI50.js";import{b as U}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__,Y=e=>{const o=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return i`<mdc-input
    @input="${r("oninput")}"
    @change="${r("onchange")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
