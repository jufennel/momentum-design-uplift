import{a8 as g,ay as S,k as o,t}from"./iframe-DLRyxUrR.js";import{c as w,s as C}from"./commonArgTypes-BG7EqI50.js";import{h as T}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,$=["Apple","Banana","Orange","Grapes","Pineapple","Mango","Strawberry","Blueberry","Watermelon","Kiwi"],F=e=>{const n=new Set($.filter(r=>r.toLowerCase().includes(e.value.toLowerCase())));return o` <mdc-searchpopover
    @input="${a("oninput")}"
    @change="${a("onchange")}"
    @focus="${a("onfocus")}"
    @blur="${a("onblur")}"
