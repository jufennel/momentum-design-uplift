import{ab as A,k as L,t as n,ac as O}from"./iframe-Cu7nV89y.js";import{i as _}from"./manifest-CGL-1vHQ.js";import{c as T,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as z}from"./utils-B5QUENNQ.js";import"./preload-helper-DvzR3F7X.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,h=e=>L`<mdc-linkbutton
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @focus="${o("onfocus")}"
    @blur="${o("onblur")}"
