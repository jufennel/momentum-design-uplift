import{W as o,k as s,R as C}from"./iframe-DttjxJGb.js";import{i as L}from"./manifest-CGL-1vHQ.js";import{c as y,s as O}from"./commonArgTypes-BG7EqI50.js";import{i}from"./imageFixtures-CD4avj2q.js";import{a as g}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const $=a=>s` <mdc-staticchip color="${a.color}" label="${a.label}" icon-name="${a["icon-name"]}"></mdc-staticchip>`,j={title:"Components/chip/staticchip",tags:["autodocs"],component:"mdc-staticchip",render:$,argTypes:{color:{control:"select",options:Object.values(o)},label:{control:"text"},"icon-name":{control:"select",options:Object.keys(L)},...y,...O}},e={args:{color:o.DEFAULT,label:"Label"}},t={args:{color:o.DEFAULT,label:"Label","icon-name":"placeholder-bold"}},c={render:()=>s` <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
    ...
    </div>`,...g()},r={render:()=>s` <div style="display: flex; gap: 0.5rem;" role="${C.MAIN}">
