import{s as h,x as se,y as x,z as T,q as le,I,k as t,C as y,t as n,p as i,E as pe}from"./iframe-Dzfa47RN.js";import{i as v}from"./manifest-CGL-1vHQ.js";import{c as be,s as ue}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,k=[9,99,999],r=e=>t`<mdc-button
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @keyup="${o("onkeyup")}"
    @focus="${o("onfocus")}"
