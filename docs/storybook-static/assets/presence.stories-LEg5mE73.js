import{m as u,aq as x,ar as t,k as s,R as f,Q as v}from"./iframe-D94Gam8m.js";import{b as S,a as $}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const g=e=>s` <mdc-presence type="${e.type}" size="${e.size}"></mdc-presence> `,T={title:"Components/avatar/presence",tags:["autodocs"],component:"mdc-presence",render:g,argTypes:{type:{options:Object.values(u),control:{type:"select"}},size:{options:Object.values(x),control:{type:"select"}},...S(["icon"])}},n={args:{type:t.TYPE,size:t.SIZE}},r={render:()=>s`
