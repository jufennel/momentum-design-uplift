import{U as V,a8 as _,M as R,N as W,k as i,t as a}from"./iframe-Ctm5TQtB.js";import{c as j,s as k}from"./commonArgTypes-BG7EqI50.js";import{b as U}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:r}=__STORYBOOK_MODULE_ACTIONS__,Y=e=>{const o=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return i`<mdc-input
    @input="${r("oninput")}"
    @change="${r("onchange")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
  ...
  `},u={argTypes:{...U(["label","help-text","required","placeholder","value","help-text-type"])},render:()=>i` <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
      ${Object.values(V).map(e=>i`<mdc-input
            help-text-type="${e}"
            label="Label"
...
}`,...(D=(H=b.parameters)==null?void 0:H.docs)==null?void 0:D.source}}};var O,z,N;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-input>
      <input slot="input" type="number" aria-label="Custom aria-label on slotted input element" value="42" />
    </mdc-input>
