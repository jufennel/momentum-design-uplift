import{x as S,y as L,s as y,C as i,k as N,R as E,t as o}from"./iframe-Cu7nV89y.js";import{i as c}from"./manifest-CGL-1vHQ.js";import{c as v,s as B}from"./commonArgTypes-BG7EqI50.js";import{h as P}from"./utils-B5QUENNQ.js";import"./preload-helper-DvzR3F7X.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,w=e=>N`<div role="${E.MAIN}">
    <mdc-buttonlink
      @click="${t("onclick")}"
      @keydown="${t("onkeydown")}"
      @focus="${t("onfocus")}"
