import{ai as Q,aj as V,k as e}from"./iframe-2vtXQJPx.js";import{c as X,s as Z}from"./commonArgTypes-BG7EqI50.js";import{h as ee,b as te,a as n}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,m="Menu Item",r=t=>e`<div role="menu" style="width: 20rem;">${t}</div>`,ne=t=>r(e` <mdc-menuitem
      @click="${i("onclick")}"
      @keydown="${i("onkeydown")}"
      @keyup="${i("onkeyup")}"
      @focus="${i("onfocus")}"
