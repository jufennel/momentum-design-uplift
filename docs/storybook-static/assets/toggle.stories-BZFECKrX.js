import{aH as x,Z as K,M as J,N as Q,aV as y,k as g,t as i}from"./iframe-Ctm5TQtB.js";import{c as X,s as ee}from"./commonArgTypes-BG7EqI50.js";import{h as te,a as S}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,oe=e=>g`
  <div role="main">
    <mdc-toggle
      name="${i(e.name)}"
      value="${i(e.value)}"
...
`,se={title:"Components/toggle",tags:["autodocs"],component:"mdc-toggle",render:oe,argTypes:{size:{control:"inline-radio",options:Object.values(x)},checked:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"soft-disabled":{control:"boolean"},"control-type":{control:"select",options:[void 0,...K]},label:{control:"text"},"help-text":{control:"text"},"auto-focus-on-mount":{control:"boolean"},required:{control:"boolean"},name:{control:"text"},value:{control:"text"},"data-aria-label":{control:"text",description:"Aria label for the toggle component. Required for accessibility."},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(J)},"toggletip-strategy":{control:"select",options:Object.values(Q)},"info-icon-aria-label":{control:"text"},...te(["help-text-type","id","validation-message","validity","willValidate"]),...X,...ee}},a={args:{name:"toggleName",value:"toggleValue",label:"Toggle label",checked:!1,size:y.SIZE,disabled:!1,readonly:!1,"soft-disabled":!1,"help-text":""}},d={args:{...a.args,size:x.DEFAULT}},m={args:{...a.args,size:x.COMPACT}},u={args:{...a.args,"help-text":"helper text"}},p={args:{size:y.SIZE},render:e=>g`
  ...
  ...hideAllControls()
}`,...(M=(H=b.parameters)==null?void 0:H.docs)==null?void 0:M.source}}};var W,P,G;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
