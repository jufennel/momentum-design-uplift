import{k as g}from"./iframe-Ctm5TQtB.js";import{c as u,s as b}from"./commonArgTypes-BG7EqI50.js";import{h as v}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const x=s=>g` <mdc-progressspinner value="${s.value}" ?error="${s.error}" data-aria-label="${s["data-aria-label"]}">
