import{b9 as d,ba as n,bm as i,k as m,bn as r}from"./iframe-2vtXQJPx.js";import{c as v,s as p}from"./commonArgTypes-BG7EqI50.js";import{b as x}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";class h extends d{constructor(){super(...arguments),this.themeProviderContext=n.consume({host:this,context:i.Context})}render(){var t;return m`
...
`,B={title:"Providers/Theme Provider",tags:["autodocs"],component:"mdc-themeprovider",render:u,argTypes:{themeclass:{options:c,control:{type:"radio"}},...x(["Context"]),...v,...p}},o={args:{themeclass:c[0],class:"custom-classname",style:"margin-top: 20px;"}};var s,a,l;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    themeclass: THEMES[0],
    class: 'custom-classname',
    style: 'margin-top: 20px;'
  }
}`,...(l=(a=o.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};const C=["Example"];export{o as Example,C as __namedExportsOrder,B as default};
