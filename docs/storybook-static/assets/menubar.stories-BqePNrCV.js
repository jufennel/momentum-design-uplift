import{k as a}from"./iframe-Ctm5TQtB.js";import{c as w,s as S}from"./commonArgTypes-BG7EqI50.js";import{b as C,h as E}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";var r=Object.freeze,A=Object.defineProperty,$=(e,i)=>r(A(e,"raw",{value:r(e.slice())})),u;const{action:D}=__STORYBOOK_MODULE_ACTIONS__,f=()=>a(u||(u=$([`
...
`])),D("onclick")),B={title:"Internal/menubar",tags:["autodocs"],component:"mdc-menubar",render:f,parameters:{badges:["stable"]},argTypes:{...w,...S,...C(["slot","default"]),...E(["menuItems","aria-orientation"])}},n={render:f},c={render:()=>{const e=i=>{const x=i.target.hasAttribute("disabled"),l=i.target.getAttribute("label"),t=i.target.getAttribute("aria-checked"),m=document.getElementById("textarea");if(!(x||!l||!m))switch(l){case"Bold":m.style.fontWeight=t==="true"?"bold":"unset";break;case"Italic":m.style.fontStyle=t==="true"?"italic":"unset";break;case"Underline":m.style.textDecoration=t==="true"?"underline":"unset";break;case"Strikethrough":m.style.textDecoration=t==="true"?"line-through":"unset";break;case"Red":m.style.color="red";break;case"Green":m.style.color="green";break;case"Blue":m.style.color="blue";break;case"Left":m.style.textAlign="left";break;case"Center":m.style.textAlign="center";break;case"Right":m.style.textAlign="right";break;case"Justify":m.style.textAlign="justify";break;case"Small":m.style.fontSize="small";break;case"Medium":m.style.fontSize="medium";break;case"Large":m.style.fontSize="large";break}};return a`
...
}`,...(y=(h=d.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};const M=["Example","EditorMenubar","WithMenuSections"];export{c as EditorMenubar,n as Example,d as WithMenuSections,M as __namedExportsOrder,B as default};
