import{aa as A,k as L,t as n,ab as O}from"./iframe-2vtXQJPx.js";import{i as _}from"./manifest-CNQCgfOm.js";import{c as T,s as E}from"./commonArgTypes-BG7EqI50.js";import{h as z}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,h=e=>L`<mdc-linkbutton
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @focus="${o("onfocus")}"
    @blur="${o("onblur")}"
