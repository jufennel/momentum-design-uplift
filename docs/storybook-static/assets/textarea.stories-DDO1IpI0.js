import{aQ as j,a7 as H,aR as W,N as c,L as B,M as X,aS as T,k as d,t as s}from"./iframe-CmSvbQSS.js";import{c as Y,s as Z}from"./commonArgTypes-BG7EqI50.js";import{h as G,b as K}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,Q=e=>d`<mdc-textarea
    @input="${i("oninput")}"
    @change="${i("onchange")}"
    @focus="${i("onfocus")}"
    @blur="${i("onblur")}"
  ...
  ></mdc-textarea>`,re={title:"Components/textarea",tags:["autodocs"],component:"mdc-textarea",render:Q,argTypes:{...Y,...Z,name:{control:"text"},value:{control:"text"},placeholder:{control:"text"},label:{control:"text"},required:{control:"boolean"},"help-text":{control:"text"},readonly:{control:"boolean"},disabled:{control:"boolean"},resizable:{control:"boolean"},rows:{control:"number"},cols:{control:"number"},wrap:{control:"select",options:Object.values(j)},minlength:{control:"number"},maxlength:{control:"number"},"max-character-limit":{control:"number"},autocapitalize:{control:"select",options:Object.values(H)},"auto-focus-on-mount":{control:"boolean"},autocomplete:{control:"select",options:Object.values(W)},dirname:{control:"text"},"data-aria-label":{control:"text"},"help-text-type":{control:"select",options:Object.values(c)},"validation-message":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(B)},"toggletip-strategy":{control:"select",options:Object.values(X)},"info-icon-aria-label":{control:"text"},"character-limit-announcement":{control:"text"},"resize-button-aria-label":{control:"text"},...G(["characterLimitExceedingFired","textarea","validity","willValidate"])}},m={args:{name:"textarea",label:"Label",rows:T.ROWS,wrap:T.WRAP,required:!0,placeholder:"Placeholder",value:"","help-text":"Help text","help-text-type":c.DEFAULT,readonly:!1,disabled:!1,resizable:!0,autocapitalize:H.OFF,autocomplete:W.OFF,"data-aria-label":"","resize-button-aria-label":"Resize textarea"}},k={name:"textarea",label:"Label",rows:T.ROWS,wrap:T.WRAP,resizable:!0},u={args:{...k,value:"Disabled & typed textarea",disabled:!0},parameters:{docs:{description:{story:"This story displays a disabled textarea component. The textarea will be displayed as disabledwhen the `disabled` attribute is set to true. The user will not be able to interact with the textarea."}}}},p={args:{...k,readonly:!0,value:"Readonly textarea"},parameters:{docs:{description:{story:"This story displays a readonly textarea component. The textarea will be displayed as readonlywhen the `readonly` attribute is set to true. The user will not be able to edit the content of the textarea."}}}},h={argTypes:{...K(["label","help-text","required","placeholder","value","help-text-type"])},render:()=>d` <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
      ${Object.values(c).map(e=>d`<mdc-textarea
            help-text-type="${e}"
            label="Label"
    ...
    `},args:{required:!0,"help-text":"","help-text-type":"default","max-character-limit":75,resizable:!0}};var g,v,w;m.parameters={...m.parameters,docs:{...(g=m.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    name: 'textarea',
    label: 'Label',
    rows: DEFAULTS.ROWS,
...
}`,...(w=(v=m.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var z,A,$;u.parameters={...u.parameters,docs:{...(z=u.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    ...commonArgs,
...
}`,...($=(A=u.parameters)==null?void 0:A.docs)==null?void 0:$.source}}};var E,R,L;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    ...commonArgs,
    readonly: true,
...
}`,...(L=(R=p.parameters)==null?void 0:R.docs)==null?void 0:L.source}}};var D,F,S;h.parameters={...h.parameters,docs:{...(D=h.parameters)==null?void 0:D.docs,source:{originalSource:`{
  argTypes: {
...
}`,...(M=(_=b.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};var U,V,P;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: args => {
...
}`,...(P=(V=y.parameters)==null?void 0:V.docs)==null?void 0:P.source}}};const le=["Example","DisabledTextarea","ReadonlyTextarea","AllVariants","TextareaWithCharacterCounter","TextareaInsideForm","TextareaInsideFormWithHelpTextValidation"];export{h as AllVariants,u as DisabledTextarea,m as Example,p as ReadonlyTextarea,b as TextareaInsideForm,y as TextareaInsideFormWithHelpTextValidation,x as TextareaWithCharacterCounter,le as __namedExportsOrder,re as default};
