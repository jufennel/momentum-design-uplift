import{s as y,x as ae,y as x,z as g,k as a,C as v,t as o}from"./iframe-2vtXQJPx.js";import{i as h}from"./manifest-CNQCgfOm.js";import{c as ie,s as re}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,r=e=>a`<mdc-button
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
