import{aC as o,aD as P,k as g}from"./iframe-BRzdycIC.js";import{c as q,s as J}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";let r=0;const a=e=>{r+=1;const t=document.getElementById("normal-content-dynamic"),y=document.getElementById("skeleton-content-dynamic");if(!t||!y)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",y.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${r}`,n.style.cssText=`
