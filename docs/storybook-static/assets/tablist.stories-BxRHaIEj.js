import{aO as k,aN as u,k as n,R as g}from"./iframe-Ctm5TQtB.js";import{h as D,d as v}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,V=(t,{updateArgs:i})=>n` <mdc-tablist
      @change="${e=>{O("onchange")(e),i({"active-tab-id":e.detail.tabId})}}"
...
This markup is not part of the component and is only provided for context. -->
    ...
    <!-- End of example markup for the tab panels -->`,P={title:"Components/tablist",tags:["autodocs"],component:"mdc-tablist",render:V,argTypes:{"active-tab-id":{control:"select",description:"ID of the active tab. Defaults to the first tab if not provided.",options:["calls-tab","videos-tab","music-tab","documents-tab","meetings-tab"]},"data-aria-label":{control:"text"},tabvariant:{control:"select",description:"Set the variant of tab inside the tablist",options:Object.values(k)},tabsize:{control:"select",description:"Set the size of tabs inside the tablist",options:Object.values(u)},...D(["itemsStore"])}},c={args:{"active-tab-id":"documents-tab","data-aria-label":"Media types",tabsize:u[32],tabvariant:"line"}},b={parameters:{...v(n` <b>Note:</b> This logic of updating the tab panels based on the active tab has been added only on this
        storybook example. <code>mdc-tablist</code> component does not control this logic. This implementation has to be
        added on the consumer's side`,!0)},render:t=>n` <mdc-tablist
        @change="${e=>{const l=document.querySelector(`mdc-tab[tab-id="${e.detail.tabId}"]`),a=l==null?void 0:l.getAttribute("aria-controls");document.querySelectorAll('[role="tabpanel"]').forEach(d=>{const s=d;s.hidden=s.id!==a})}}"
        active-tab-id="${t["active-tab-id"]}"
        data-aria-label=${t["data-aria-label"]}
      >
        <mdc-tab
...
This markup is not part of the component and is only provided for context. -->
      ...
      <!-- End of example markup for the tab panels -->`,args:{tabvariant:"glass",tabsize:u[32],"active-tab-id":"documents-tab","data-aria-label":"Media types"}},r={render:()=>n`
    <div role="${g.MAIN}">
      <mdc-tablist active-tab-id="tab-2" data-aria-label="Tablist with a lot of tabs">
        ${new Array(100).fill(void 0).map((t,i)=>n`<mdc-tab text="Tab #${i+1}" tab-id="tab-${i+1}"></mdc-tab>`)}
      </mdc-tablist>
    </div>
  `,...v(n`<p role="${g.REGION}">
      ...
      </p>`,!0)},render:()=>{const t="tablist-dialog",i=()=>{const a=document.getElementById(t);a==null||a.toggleAttribute("visible")},e=()=>{const a=document.getElementById(t);a==null||a.removeAttribute("visible")};return n`
      ...
      >
        <div slot="dialog-body">
          <mdc-tablist @change="${a=>{const o=document.getElementById(t),d=o==null?void 0:o.querySelector(`mdc-tab[tab-id="${a.detail.tabId}"]`),s=d==null?void 0:d.getAttribute("aria-controls"),p=o==null?void 0:o.querySelectorAll('[role="tabpanel"]');p==null||p.forEach(w=>{const h=w;h.hidden=h.id!==s})}}" active-tab-id="calls-tab" data-aria-label="Media types">
        ...
        <mdc-button slot="footer-button-secondary" @click="${e}">Cancel</mdc-button>
        <mdc-button slot="footer-button-primary" @click="${e}">Confirm</mdc-button>
      </mdc-dialog>
...
}`,...(M=(S=m.parameters)==null?void 0:S.docs)==null?void 0:M.source}}};const q=["Example","TablistWithPanels","TablistWithButtons","TablistInsideDialog"];export{c as Example,m as TablistInsideDialog,r as TablistWithButtons,b as TablistWithPanels,q as __namedExportsOrder,P as default};
