import{M as l,a0 as Ee,a1 as Te,N as Ie,Y as t,k as o,h as r,t as u}from"./iframe-Ctm5TQtB.js";import{h as fe,a as ke,d as xe}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,a=(e,n)=>o`
  <mdc-popover
    id="${e.id}"
...
`,Ae=e=>o`
  ...
  ${a(e,o`<mdc-text tagname=${r.SPAN}>Lorem ipsum dolor sit amet.</mdc-text>`)}
`,De=e=>o`
...
`,we=e=>o`
  ...
  ${a(e,o`<mdc-text tagname=${r.SPAN} style="width: 13rem;">Interactive content on click</mdc-text>`)}
...
`,Oe=e=>o`
  ...
  ${a(e,o`<mdc-text tagname=${r.SPAN}>Popover Level 1</mdc-text>
...
`,_e={title:"Components/popover",tags:["autodocs"],component:"mdc-popover",render:Ae,argTypes:{id:{control:"text"},triggerID:{control:"text"},trigger:{control:"text"},placement:{control:"select",options:Object.values(l)},offset:{if:{arg:"offset"},control:"number"},visible:{control:"boolean"},delay:{control:"text"},color:{control:"select",options:Object.values(Ee)},"disable-flip":{control:"boolean"},size:{control:"boolean"},backdrop:{control:"boolean"},"z-index":{if:{arg:"z-index"},control:"number"},"show-arrow":{control:"boolean"},"close-button":{control:"boolean"},interactive:{control:"boolean"},"focus-trap":{control:"boolean"},"should-focus-trap-wrap":{control:"boolean"},"prevent-scroll":{control:"boolean"},"hide-on-blur":{control:"boolean"},"hide-on-escape":{control:"boolean"},"hide-on-outside-click":{control:"boolean"},"focus-back-to-trigger":{control:"boolean"},"append-to":{control:"text"},"element-index-to-receive-focus":{control:"number"},"close-button-aria-label":{control:"text"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},"aria-describedby":{control:"text"},role:{control:"text"},"disable-aria-expanded":{control:"boolean"},"backdrop-append-to":{control:"text"},"is-backdrop-invisible":{control:"boolean"},boundary:{control:"text"},"boundary-padding":{control:"number"},"boundary-root":{control:"select",options:Object.values(Te)},strategy:{control:"select",options:Object.values(Ie)},...fe(["aria-label","arrowElement","hide","show","togglePopoverVisible","triggerElement","utils"])}},m={args:{id:"popover",triggerID:"popover-trigger",trigger:"click",placement:l.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"show-arrow":!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!0,interactive:t.INTERACTIVE}},v={render:De,args:{id:"popover-interactive",triggerID:"popover-trigger-interactive",trigger:"click",placement:l.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"focus-trap":!0,interactive:!0,"show-arrow":!0,"disable-flip":t.DISABLE_FLIP,size:!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!1,"element-index-to-receive-focus":5}},b={render:Le,args:{id:"popover-interactive-hover",triggerID:"popover-trigger-interactive-hover",trigger:"mouseenter",placement:l.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,"focus-back-to-trigger":!0,role:t.ROLE,color:t.COLOR}},h={render:we,args:{id:"popover-multiple",triggerID:"popover-trigger-multiple",trigger:"click",placement:l.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"focus-back-to-trigger":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"show-arrow":!0,"close-button":!0,role:t.ROLE,color:t.COLOR,"keep-connected-tooltip-open":!1}},x={render:Oe,args:{id:"popover-nested",triggerID:"popover-trigger-nested",trigger:"click",placement:l.TOP,offset:t.OFFSET,"z-index":10,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,role:t.ROLE,color:t.COLOR,"focus-back-to-trigger":!0,"hide-on-outside-click":!0}},E={render:Se,args:{id:"popover-hide-on-blur",triggerID:"popover-trigger-hide-on-blur",trigger:"click",placement:l.RIGHT,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,"hide-on-blur":!0,role:t.ROLE,color:t.COLOR}},T={render:$e,args:{id:"popover-backdrop",triggerID:"popover-trigger-backdrop",trigger:"click",placement:l.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"disable-flip":t.DISABLE_FLIP,interactive:!0,"show-arrow":!0,backdrop:!0,"hide-on-outside-click":!0,"focus-trap":!0,role:t.ROLE,color:t.COLOR},parameters:{docs:{description:{story:o`This example shows how to use the \`backdrop\` property to create a modal popover.<br />
  ...
  `},k={parameters:{...xe(o`
      ...
      `,!0)},render:()=>{const e=c=>{var d;const s=c.target;(d=s.querySelector(".hover-menu"))==null||d.appendChild(document.getElementById(s.dataset.tpl).content.cloneNode(!0))},n=c=>{const s=c.target.querySelector(".hover-menu");s.innerHTML=""};return o`
      <style>
        .container {
          width: 25rem;
          height: 10rem;
    ...
    `}},A={args:{...m.args,placement:l.RIGHT_START,triggerID:"trigger-btn"},render:()=>o`
    ${p("popover-trigger-interactive","Click me!")}
    <mdc-popover
      id="popover"
  ...
  `},D={args:{...m.args,id:"popover",placement:l.RIGHT_START,triggerID:"trigger-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"keep-connected-tooltip-open":!0},render:e=>o`
    ${p(e.triggerID,"Click me!")}
    ${a(e,o`
        <mdc-button
  ...
  `},L={args:{...m.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},render:e=>o`
  ...
  `},S={args:{...m.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},parameters:{...xe(o` <mdc-text>
    ...
    `}};var $,y,P;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    id: 'popover',
...
}`,...(P=(y=m.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};var F,_,B;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(V=(M=h.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};var z,H,X;x.parameters={...x.parameters,docs:{...(z=x.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: renderNested,
  args: {
    id: 'popover-nested',
...
}`,...(X=(H=x.parameters)==null?void 0:H.docs)==null?void 0:X.source}}};var G,Y,q;E.parameters={...E.parameters,docs:{...(G=E.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(q=(Y=E.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};var Z,j,W;T.parameters={...T.parameters,docs:{...(Z=T.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  ...
  \`,
  ...hideAllControls()
}`,...(Q=(J=I.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var ee,te,oe;f.parameters={...f.parameters,docs:{...(ee=f.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      .container {
        display: flex;
  ...
  \`
}`,...(oe=(te=f.parameters)==null?void 0:te.docs)==null?void 0:oe.source}}};var re,ne,ie;k.parameters={...k.parameters,docs:{...(re=k.parameters)==null?void 0:re.docs,source:{originalSource:`{
  parameters: {
    ...describeStory(html\`
        <mdc-text> To breakout stacking context is necessary to use append to. </mdc-text>
        <mdc-text> Trigger and popover dynamically added to the DOM </mdc-text>
...
}`,...(ie=(ne=k.parameters)==null?void 0:ne.docs)==null?void 0:ie.source}}};var ce,de,le;A.parameters={...A.parameters,docs:{...(ce=A.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(le=(de=A.parameters)==null?void 0:de.docs)==null?void 0:le.source}}};var ae,pe,me;D.parameters={...D.parameters,docs:{...(ae=D.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover',
    placement: POPOVER_PLACEMENT.RIGHT_START,
  ...
  \`
}`,...(me=(pe=D.parameters)==null?void 0:pe.docs)==null?void 0:me.source}}};var se,ue,ge;L.parameters={...L.parameters,docs:{...(se=L.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    ...Example.args,
...
}`,...(he=(be=S.parameters)==null?void 0:be.docs)==null?void 0:he.source}}};const Be=["Example","interactiveContent","interactiveHover","interactiveMultiple","nestedPopover","hideOnBlur","popoverWithBackdrop","popoverWithSelect","MultipleSingleLevelPopovers","AppendTo","NestedMenu","PopoverWithTooltipAndDialog","PopoverScrollOverflow","PopoverInChangingList"];export{k as AppendTo,m as Example,f as MultipleSingleLevelPopovers,A as NestedMenu,S as PopoverInChangingList,L as PopoverScrollOverflow,D as PopoverWithTooltipAndDialog,Be as __namedExportsOrder,_e as default,E as hideOnBlur,v as interactiveContent,b as interactiveHover,h as interactiveMultiple,x as nestedPopover,T as popoverWithBackdrop,I as popoverWithSelect};
