import{w as e,k as c,t as d}from"./iframe-BRzdycIC.js";import{c as u,s as p}from"./commonArgTypes-BG7EqI50.js";import{a as b}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const g=n=>c` <mdc-bullet size="${d(n.size)}"></mdc-bullet>`,S={title:"Components/decorator/bullet",tags:["autodocs"],component:"mdc-bullet",render:g,argTypes:{size:{control:"select",options:Object.values(e)},...u,...p},parameters:{actions:{disable:!0}}},l={args:{size:e.SMALL}},t={render:()=>c`
    <main>
