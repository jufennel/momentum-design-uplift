import{U as X,$ as l,G as t,k as h,t as a}from"./iframe-CZNJ8fux.js";import{c as Z,s as ee}from"./commonArgTypes-BG7EqI50.js";import{h as ae,a as x}from"./utils-B5QUENNQ.js";import"./preload-helper-DvzR3F7X.js";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,S=Object.values(X).filter(e=>e!=="priority"),le=e=>h`
  <mdc-datepicker
    @change="${n("onchange")}"
    @input="${n("oninput")}"
    @focus="${n("onfocus")}"
    ...
    locale-range-start-selected-label="${a(e["locale-range-start-selected-label"])}"
    append-to="${a(e["append-to"])}"
    backdrop-append-to="${a(e["backdrop-append-to"])}"
  ></mdc-datepicker>
`,ce={title:"Components/datepicker",tags:["autodocs"],component:"mdc-datepicker",render:le,argTypes:{label:{control:"text"},value:{control:"text",description:"Selected date as ISO string (yyyy-mm-dd)"},"end-value":{control:"text",description:"Range end date as an ISO string (yyyy-mm-dd)"},variant:{control:"select",options:Object.values(l),description:"Variant: input (spinbuttons) or default (select trigger)"},"selection-mode":{control:"select",options:Object.values(t)},locale:{control:"text",description:"BCP 47 locale string"},required:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${S.map(e=>`'${e}'`).join(", ")}.`,options:S},min:{control:"text",description:"Minimum selectable date (ISO string)"},max:{control:"text",description:"Maximum selectable date (ISO string)"},"locale-month-label":{control:"text"},"locale-day-label":{control:"text"},"locale-year-label":{control:"text"},"locale-calendar-label":{control:"text"},"locale-today-label":{control:"text"},"locale-spinbutton-description":{control:"text"},"locale-prev-month-label":{control:"text"},"locale-next-month-label":{control:"text"},"locale-range-start-selected-label":{control:"text"},"append-to":{control:"text"},"backdrop-append-to":{control:"text"},...ae(["validation-message","validity","willValidate","dayInput","monthInput","yearInput","displayPopover","internalMonth","internalDay","internalYear","effectiveSelectionMode","pendingDigits","pendingDigitTimeout"]),...Z,...ee}},o={args:{label:"Start date",variant:l.INPUT,"selection-mode":t.SINGLE,locale:"en-US",required:!0,"help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year","locale-calendar-label":"Open calendar","locale-today-label":"Today","locale-spinbutton-description":"Use arrow keys to change the value or type a number"}},r={args:{label:"Start date",value:"2025-07-15",variant:l.INPUT,locale:"en-US",required:!0,"help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year","locale-calendar-label":"Open calendar","locale-today-label":"Today"}},c={args:{label:"Date range",variant:l.DEFAULT,"selection-mode":t.RANGE,locale:"en-US",required:!0,"help-text":"Select a start and end date","locale-today-label":"Today","locale-range-start-selected-label":"Start date selected. Select an end date."}},d={args:{label:"Date range",value:"2025-07-13","end-value":"2025-07-19",variant:l.DEFAULT,"selection-mode":t.RANGE,locale:"en-US",required:!0,"help-text":"Helper text","locale-today-label":"Today"}},i={args:{label:"Select week",variant:l.DEFAULT,"selection-mode":t.WEEK,locale:"en-US","help-text":"Click a date to select its week","locale-today-label":"Today","locale-prev-month-label":"Go to previous month","locale-next-month-label":"Go to next month"}},s={args:{label:"Start date",value:"2025-07-15",variant:l.INPUT,disabled:!0,locale:"en-US","help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},p={args:{label:"Start date",value:"2025-07-15",variant:l.INPUT,readonly:!0,locale:"en-US","help-text":"Helper text","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},b={args:{label:"End date",value:"2025-07-14",variant:l.INPUT,locale:"en-US",required:!0,"help-text":"End date must occur after start date","help-text-type":"error","locale-month-label":"Month","locale-day-label":"Day","locale-year-label":"Year"}},m={render:()=>h`
  ...
  `,...x()},y={render:()=>h`
    ...
    ></mdc-datepicker>
  `,...x()};var v,T,E;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    label: 'Start date',
...
}`,...(E=(T=o.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var D,g,U;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    label: 'Start date',
    value: '2025-07-15',
    variant: VARIANT.INPUT,
...
}`,...(U=(g=r.parameters)==null?void 0:g.docs)==null?void 0:U.source}}};var I,A,k;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    label: 'Date range',
...
}`,...(k=(A=c.parameters)==null?void 0:A.docs)==null?void 0:k.source}}};var N,O,$;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    label: 'Date range',
    value: '2025-07-13',
...
}`,...($=(O=d.parameters)==null?void 0:O.docs)==null?void 0:$.source}}};var M,f,V;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    label: 'Select week',
    variant: VARIANT.DEFAULT,
...
}`,...(V=(f=i.parameters)==null?void 0:f.docs)==null?void 0:V.source}}};var q,L,R;s.parameters={...s.parameters,docs:{...(q=s.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Start date',
    value: '2025-07-15',
    variant: VARIANT.INPUT,
...
}`,...(R=(L=s.parameters)==null?void 0:L.docs)==null?void 0:R.source}}};var P,Y,C;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    label: 'Start date',
    value: '2025-07-15',
    variant: VARIANT.INPUT,
...
}`,...(C=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:C.source}}};var H,G,_;b.parameters={...b.parameters,docs:{...(H=b.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    label: 'End date',
    value: '2025-07-14',
    variant: VARIANT.INPUT,
...
}`,...(_=(G=b.parameters)==null?void 0:G.docs)==null?void 0:_.source}}};var W,w,j;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      <mdc-datepicker
        label="Start date"
