import{al as c,Z as D,k as l,t as f}from"./iframe-B8woZv37.js";import{c as v,s as U}from"./commonArgTypes-BG7EqI50.js";import{h as W,a as L}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,M=e=>l`<div role="menu" style="width: 25rem;">${e}</div>`,O=e=>M(l` <mdc-menuitemcheckbox
      @change="${a("onchange")}"
      @click="${a("onclick")}"
      @focus="${a("onfocus")}"
      ?disabled="${e.disabled}"
