import{p as e,I as V,q as i,k as g}from"./iframe-Bzl5oY3a.js";import{i as G}from"./manifest-CNQCgfOm.js";import{c as q,s as F}from"./commonArgTypes-BG7EqI50.js";import{a as X}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const r=[9,99,999],j=a=>g`
  <mdc-badge
    type="${a.type}"
...
`,Z={title:"Components/badge",tags:["autodocs"],component:"mdc-badge",render:j,argTypes:{type:{control:"select",options:Object.values(e)},overlay:{control:"boolean"},counter:{if:{arg:"type",eq:e.COUNTER},control:"number"},"max-counter":{if:{arg:"type",eq:e.COUNTER},control:"select",options:r},"icon-name":{if:{arg:"type",eq:e.ICON},control:"select",options:Object.keys(G)},variant:{if:{arg:"type",eq:e.ICON},control:"select",options:Object.values(V)},"aria-label":{control:"text"},...q,...F}},o={args:{type:i.TYPE,"icon-name":"placeholder-bold",variant:i.VARIANT,counter:1,"max-counter":r[1],overlay:!1}},n={args:{type:i.TYPE,"icon-name":"placeholder-bold",variant:i.VARIANT,counter:1,"max-counter":r[1]}},t={args:{type:e.ICON,"icon-name":"placeholder-bold",variant:V.PRIMARY}},c={args:{type:e.COUNTER,counter:10,"max-counter":r[1]}},d={args:{type:e.SUCCESS}},s={args:{type:e.WARNING}},m={args:{type:e.ERROR,overlay:!1}},l={render:z,args:{type:e.COUNTER,counter:1e3,"max-counter":r[2],overlay:!0}},p={render:()=>g`
  ...
  `,...X()};var y,b,u;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
...
}`,...(Y=(P=s.parameters)==null?void 0:P.docs)==null?void 0:Y.source}}};var x,f,_;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    type: TYPE.ERROR,
    overlay: false
  }
}`,...(_=(f=m.parameters)==null?void 0:f.docs)==null?void 0:_.source}}};var W,D,L;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(L=(D=l.parameters)==null?void 0:D.docs)==null?void 0:L.source}}};var k,w,M;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => html\`
    <h5>Without overlay</h5>
    <div style="display: flex; justify-content: space-between; align-items: center; width: 10rem;">
  ...
  \`,
  ...hideAllControls()
}`,...(M=(w=p.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};const ee=["Example","Dot","Icon","Counter","Success","Warning","Error","Overlay","AllVariants"];export{p as AllVariants,c as Counter,n as Dot,m as Error,o as Example,t as Icon,l as Overlay,d as Success,s as Warning,ee as __namedExportsOrder,Z as default};
