import{a0 as O,M as k,aX as S,Y as A,aY as e,k as d}from"./iframe-Ctm5TQtB.js";import{h as D}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,E=t=>d`
...
`,F={title:"Components/tooltip",tags:["autodocs"],component:"mdc-tooltip",render:E,argTypes:{children:{control:"text"},color:{control:"select",options:Object.values(O)},delay:{control:"text"},id:{description:"The id of the tooltip(optional, if not set, a random id will be generated)",control:"text"},offset:{control:"number"},placement:{control:"select",options:Object.values(k)},"show-arrow":{control:"boolean"},"tooltip-type":{control:"select",options:Object.values(S)},triggerID:{control:"text"},...D(["trigger","z-index","disable-flip","role","focus-trap","prevent-scroll","close-button","interactive","hide-on-escape","hide-on-blur","hide-on-outside-click","focus-back-to-trigger","backdrop","size","append-to","close-button-aria-label","aria-labelledby","aria-describedby","show","hide","togglePopoverVisible","arrowElement","onOutsidePopoverClick","onEscapeKeydown","onPopoverFocusOut","startCloseDelay","cancelCloseDelay","enabledPreventScroll","enabledFocusTrap","shouldWrapFocus","utils","defaultSlotNodes"])}},i={render:E,args:{children:"This is a tooltip",color:A.COLOR,delay:e.DELAY,id:"tooltip",offset:e.OFFSET,placement:e.PLACEMENT,"show-arrow":e.SHOW_ARROW,triggerID:"tooltip-trigger","tooltip-type":e.TOOLTIP_TYPE,visible:!1}},n={render:()=>{let t=!1;const a="width: 100px;";return d`
      <mdc-text
        id="text"
      ...
      <hr />
      <mdc-button @click=${()=>{t=!t;const c=document.getElementById("text"),m=document.getElementById("button"),o="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;";t?(c.setAttribute("style",o),m.setAttribute("style",o)):(c.setAttribute("style",a+o),m.setAttribute("style",a+o))}}>Toggle Width</mdc-button>
    `}},r={render:()=>d`
  ...
  `};var p,g,h;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render,
  args: {
...
}`,...(h=(g=i.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var b,u,w;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => {
    let toggle = false;
...
}`,...(w=(u=n.parameters)==null?void 0:u.docs)==null?void 0:w.source}}};var y,v,x;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-popover visible hide-on-outside-click>
      <div style="margin: 10rem; width: 8rem;">
        <p>Click below button & Hover on Label 5</p>
  ...
  \`
}`,...(x=(v=r.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var f,T,L;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => html\`
    <div style="margin: 100px; max-width: 300px;">
      <mdc-text type="body-large-regular" tagname="p">
        Here is some text with a
  ...
  \`
}`,...(L=(T=s.parameters)==null?void 0:T.docs)==null?void 0:L.source}}};const W=["Example","TooltipOnTextOverflow","TooltipInsidePopover","TooltipOnInlineLink"];export{i as Example,r as TooltipInsidePopover,s as TooltipOnInlineLink,n as TooltipOnTextOverflow,W as __namedExportsOrder,F as default};
