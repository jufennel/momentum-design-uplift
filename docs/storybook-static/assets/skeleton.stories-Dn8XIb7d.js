import{aB as o,aC as P,k as g}from"./iframe-Bzl5oY3a.js";import{c as q,s as J}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";let r=0;const a=e=>{r+=1;const t=document.getElementById("normal-content-dynamic"),y=document.getElementById("skeleton-content-dynamic");if(!t||!y)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",y.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${r}`,n.style.cssText=`
...
`,oe={title:"Components/skeleton",tags:["autodocs"],component:"mdc-skeleton",render:X,argTypes:{variant:{control:"select",options:Object.values(o)},motion:{control:"boolean"},...q,...J}},s={args:{variant:P.VARIANT}},i={args:{variant:o.RECTANGULAR}},d={args:{variant:o.ROUNDED}},c={args:{variant:o.CIRCULAR}},l={args:{variant:o.BUTTON}},p={args:{motion:!0,variant:P.VARIANT}},m={render:Y,args:{variant:o.RECTANGULAR}},u={render:e=>g`
  ...
  `,args:{variant:o.RECTANGULAR}},x={render:Z,args:{variant:o.RECTANGULAR}};var h,C,A;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    variant: DEFAULTS.VARIANT
  }
}`,...(A=(C=s.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};var T,f,E;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
...
}`,...(D=(U=l.parameters)==null?void 0:U.docs)==null?void 0:D.source}}};var O,B,V;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    motion: true,
    variant: DEFAULTS.VARIANT
  }
}`,...(V=(B=p.parameters)==null?void 0:B.docs)==null?void 0:V.source}}};var _,G,K;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: renderWithContent,
  args: {
    variant: SKELETON_VARIANTS.RECTANGULAR
  }
}`,...(K=(G=m.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var M,W,H;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
...
}`,...(H=(W=u.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};var z,F,j;x.parameters={...x.parameters,docs:{...(z=x.parameters)==null?void 0:z.docs,source:{originalSource:`{
