import{v as t,h as v,aZ as f,k as n,t as T}from"./iframe-2vtXQJPx.js";import{c as ce,s as me}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";var E=Object.freeze,oe=Object.defineProperty,pe=(e,d)=>E(oe(e,"raw",{value:E(e.slice())})),k;const{action:I}=__STORYBOOK_MODULE_ACTIONS__,le=e=>n`
  <mdc-typewriter
    @change="${I("change")}"
    @typing-complete="${I("typing-complete")}"
    type="${e.type}"
    tagname="${T(e.tagname)}"
    speed="${e.speed}"
    max-queue-size="${T(e["max-queue-size"])}"
    >${e.children}</mdc-typewriter
  >
`,we={title:"Widgets/typewriter",tags:["autodocs"],component:"mdc-typewriter",render:le,argTypes:{children:{control:"text",description:'Children (passed into "default" slot)'},type:{control:"select",options:Object.values(t)},tagname:{control:"select",options:Object.values(v)},speed:{control:"text",description:'Speed of typewriter effect. Use preset values ("slow", "normal", "fast", "very-slow", "very-fast") or numeric strings ("100", "50", etc.) in milliseconds per character.'},"max-queue-size":{control:{type:"number",min:1,max:1e3,step:1},description:"Maximum number of text chunks in queue before dropping oldest chunks. Set to high value for unlimited."},...ce,...me}},s={args:{type:f.TYPE,tagname:null,speed:f.SPEED,children:"The quick brown fox jumps over the lazy dog"}},c={args:{type:t.HEADING_LARGE_BOLD,tagname:v.H2,speed:"slow",children:"This types more slowly for emphasis"}},m={args:{type:t.BODY_MIDSIZE_MEDIUM,tagname:v.P,speed:"fast",children:"This types very quickly! Almost like someone who is excited about something!"}},o={render:()=>n`
    <div>
      <mdc-typewriter
  ...
  `},p={render:()=>n`
    <div>
      ...
      <mdc-typewriter id="dynamic-speed-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="120">
  ...
  `},l={render:()=>n`
    <div>
      ...
      <mdc-typewriter id="chunked-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="60">
        Initial text.
      </mdc-typewriter>
  ...
  `},y={render:()=>n`
    <div>
      ...
      <mdc-typewriter type="${t.BODY_LARGE_REGULAR}" speed="normal" id="dynamic-typewriter-a11y">
  ...
  `},u={render:()=>n`
    <div>
      <mdc-typewriter id="dynamic-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="normal">
  ...
  `])),t.BODY_LARGE_REGULAR,()=>{const e=document.getElementById("dynamic-combined-typewriter"),d=document.getElementById("custom-text-input"),r=document.getElementById("speed-selector"),i=document.getElementById("custom-speed-input");if(e&&d&&r){const a=d.value.trim();if(!a)return;let b=r.value;r.value==="custom"&&i.value&&(b=i.value),e.addTextChunk(` ${a}`,b),d.value=""}},()=>{const e=document.getElementById("dynamic-combined-typewriter"),d=document.getElementById("speed-selector"),r=document.getElementById("custom-speed-input");if(e&&d){let i=d.value;d.value==="custom"&&r.value&&(i=r.value),e.speed=i}},()=>{const e=document.getElementById("dynamic-combined-typewriter");e&&e.addTextChunk(" 🚀 Super fast chunk!","15")},()=>{const e=document.getElementById("dynamic-combined-typewriter");e&&e.addTextChunk(" This chunk types slowly to demonstrate temporary speed override.","150")},()=>{const e=document.getElementById("dynamic-combined-typewriter");e&&(e.speed="20",e.addTextChunk(" Base speed changed to fast!"))},()=>{const e=document.getElementById("dynamic-combined-typewriter");e&&(e.textContent="Reset! Ready for new content.",e.speed="60")})},w={render:()=>n`
    <div>
      ...
      <mdc-typewriter id="instant-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="normal">
  ...
  `},h={render:()=>n`
    <div>
      ...
      <mdc-typewriter id="mixed-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="normal">
        Starting text...
      </mdc-typewriter>
  ...
  `},x={render:()=>n`
    <div>
      ...
      <mdc-typewriter id="rapid-typewriter" type="${t.BODY_LARGE_REGULAR}" speed="fast"> Live Feed: </mdc-typewriter>

      <div style="margin-top: 20px; display: flex; gap: 12px; flex-wrap: wrap;">
        <mdc-button
          variant="primary"
          @click=${()=>{const e=document.getElementById("rapid-typewriter");e&&["User123 joined","New message received","System update complete","Alert: High traffic detected","Database sync finished"].forEach((r,i)=>{setTimeout(()=>{const a=new Date().toLocaleTimeString();e.addInstantTextChunk(`
[${a}] ${r}`)},i*500)})}}
        >
  ...
  `};var S,A,C;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
    tagname: null,
...
}`,...(C=(A=s.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};var B,D,R;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(D=c.parameters)==null?void 0:D.docs)==null?void 0:R.source}}};var $,L,_;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
...
}`,...(_=(L=m.parameters)==null?void 0:L.docs)==null?void 0:_.source}}};var G,U,Y;o.parameters={...o.parameters,docs:{...(G=o.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-typewriter
        id="custom-speed-typewriter"
  ...
  \`
}`,...(Y=(U=o.parameters)==null?void 0:U.docs)==null?void 0:Y.source}}};var O,N,M;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Dynamic Speed Adjustment</mdc-text>
      <mdc-text type="body-large-regular" tagname="p">
  ...
  \`
}`,...(M=(N=p.parameters)==null?void 0:N.docs)==null?void 0:M.source}}};var P,F,q;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Chunked Text Addition</mdc-text>
      <mdc-text type="body-large-regular" tagname="p">
  ...
  \`
}`,...(q=(F=l.parameters)==null?void 0:F.docs)==null?void 0:q.source}}};var H,j,V;y.parameters={...y.parameters,docs:{...(H=y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Accessibility Features Demo</mdc-text>
      <mdc-text type="body-large-regular" tagname="p"
  ...
  \`
}`,...(V=(j=y.parameters)==null?void 0:j.docs)==null?void 0:V.source}}};var z,X,W;u.parameters={...u.parameters,docs:{...(z=u.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => html\`
    <div>
  ...
  \`
}`,...(W=(X=u.parameters)==null?void 0:X.docs)==null?void 0:W.source}}};var Z,Q,K;g.parameters={...g.parameters,docs:{...(Z=g.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Dynamic Text + Speed Control</mdc-text>
      <mdc-text type="body-large-regular" tagname="p"> This demo shows two different ways to control speed: </mdc-text>
  ...
  \`
}`,...(K=(Q=g.parameters)==null?void 0:Q.docs)==null?void 0:K.source}}};var J,ee,te;w.parameters={...w.parameters,docs:{...(J=w.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Instant Text Addition</mdc-text>
      <mdc-text type="body-large-regular" tagname="p"
  ...
  \`
}`,...(te=(ee=w.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ne,de,re;h.parameters={...h.parameters,docs:{...(ne=h.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Mixed Instant & Animated Chunks</mdc-text>
      <mdc-text type="body-large-regular" tagname="p"
  ...
  \`
}`,...(re=(de=h.parameters)==null?void 0:de.docs)==null?void 0:re.source}}};var ie,ae,se;x.parameters={...x.parameters,docs:{...(ie=x.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => html\`
    <div>
      <mdc-text type="heading-large-bold" tagname="h3">Rapid Updates Use Case</mdc-text>
      <mdc-text type="body-large-regular" tagname="p"
  ...
  \`
}`,...(se=(ae=x.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};const he=["Example","SlowTyping","FastTyping","CustomSpeed","DynamicSpeedDemo","ChunkedTextDemo","AccessibilityDemo","DynamicExample","DynamicTextAndSpeedDemo","InstantTextDemo","MixedChunksDemo","RapidUpdatesDemo"];export{y as AccessibilityDemo,l as ChunkedTextDemo,o as CustomSpeed,u as DynamicExample,p as DynamicSpeedDemo,g as DynamicTextAndSpeedDemo,s as Example,m as FastTyping,w as InstantTextDemo,h as MixedChunksDemo,x as RapidUpdatesDemo,c as SlowTyping,he as __namedExportsOrder,we as default};
