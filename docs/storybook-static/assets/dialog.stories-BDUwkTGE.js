import{a2 as Ge,i as He,a3 as a,l,k as o,N as w,t as B}from"./iframe-Ctm5TQtB.js";import{c as Fe,s as Me}from"./commonArgTypes-BG7EqI50.js";import{d as Ue}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:g}=__STORYBOOK_MODULE_ACTIONS__,d=(e,t,i)=>o`<mdc-dialog
    class="${e.class}"
    style="${e.style}"
    id="${e.id}"
    z-index="${e["z-index"]}"
    ...
    aria-labelledby="${B(e["aria-labelledby"])}"
    aria-label="${B(e["aria-label"])}"
...
`,qe=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
  ...
  `},Qe=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ...
    ${d(e,Re(t),i)}
  `},et=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById("nested-dialog").toggleAttribute("visible")},r=()=>{document.getElementById(e.id).removeAttribute("visible")},p=()=>{document.getElementById("nested-dialog").removeAttribute("visible")};return o`
    ${c(e.triggerId,"Click me!",t)}
    ${d(e,o`
        <div slot="dialog-body">
          <p>This is the body content of the dialog.</p>
      ...
      `,r)}
  `},tt=e=>{const t=()=>{document.getElementById("outer-dialog").toggleAttribute("visible")},i=()=>{document.getElementById("nested-dialog").toggleAttribute("visible")},r=()=>{document.getElementById("outer-dialog").removeAttribute("visible")},p=()=>{document.getElementById("nested-dialog").removeAttribute("visible")};return o`
    <style>
      #dialog {
      ...
      <mdc-dialog id="outer-dialog" .onClose="${r}">
        <div slot="dialog-body">
          ...
          <mdc-popover
            ...
            interactive
            focus-trap
            strategy="${e.lvl2PopoverStrategy==="append to root"?w.ABSOLUTE:e.lvl2PopoverStrategy}"
            append-to="${B(e.lvl2PopoverStrategy==="append to root"?"root":void 0)}"
          >
            <p>Popover lvl 2.</p>
  ...
  <mdc-list aria-label="${t}">
    ...
    <mdc-listitem @click=${g("onclick")} label="List Item 1">
    ...
    <mdc-listitem @click=${g("onclick")} label="List Item 2">
      <mdc-checkbox slot="leading-controls" data-aria-label="mock label"></mdc-checkbox>
      <span slot="secondary-label ">This is a long secondary label</span>
      <mdc-button slot="trailing-controls" variant="secondary">Label</mdc-button>
      <mdc-toggle slot="trailing-controls" data-aria-label="mock label"></mdc-toggle>
    </mdc-listitem>
    <mdc-listitem @click=${g("onclick")} label="List Item 3">
      <mdc-checkbox slot="leading-controls" data-aria-label="mock label"></mdc-checkbox>
      <span slot="secondary-label ">This is a long secondary label</span>
      <mdc-button slot="trailing-controls" variant="secondary">Label</mdc-button>
      <mdc-toggle slot="trailing-controls" data-aria-label="mock label"></mdc-toggle>
...
`,ct={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:qe,argTypes:{...Fe,...Me,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(Ge)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},"hide-backdrop":{control:"boolean"},role:{control:"select",options:Object.values(He)},size:{control:"select",options:Object.values(a)},visible:{control:"boolean"}}},n={id:"dialog","z-index":l.Z_INDEX,role:l.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:l.VARIANT},s={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":l.HEADER_TAG_NAME,"description-tag-name":l.DESCRIPTION_TAG_NAME},u={args:{size:l.SIZE,...n,...s}},b={args:{size:l.SIZE,...n,...s,"hide-backdrop":!0},parameters:{docs:{description:{story:"This example shows a dialog without a backdrop. The backdrop can be disabled by setting the `hide-backdrop` attribute to `true`. When disabled, users can interact with elements behind the dialog."}}}},h={name:"Size: Small",args:{size:a[0],...n,...s}},v={name:"Size: Medium",args:{size:a[1],...n,...s}},y={name:"Size: Large",args:{size:a[2],...n,...s}},I={name:"Size: XLarge",args:{size:a[3],...n,...s}},S={name:"Size: Fullscreen",args:{size:a[4],...n,...s}},x={args:{...n,size:a[0]}},D={render:Je,args:{...n,size:a[0]}},f={render:Xe,args:{...n,...s,size:l.SIZE}},E={render:Ke,args:{...n,...s,size:l.SIZE}},A={render:e=>o`
  ...
  `},T={render:e=>{const t=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ...
    `},args:{...n,...s,size:l.SIZE,mountDialog:!0,visible:!0}},$={render:Qe,args:{...n,size:a[0]}},k={render:et,args:{...n,size:a[0]}},P="Level 2 Popover's strategy",z={render:tt,argTypes:{[P]:{control:"select",options:[...Object.values(w),"append to root"]}},args:{[P]:w.ABSOLUTE},...Ue("Demo multiple level overlays nested into each other. They should maintains consistent (monotonic) z-indexing and Esc key handling. Esc should close only the top-most overlay (even tooltips)."),parameters:{controls:{include:[P]}}},C={render:it,args:{...n,size:a[0]}},L={render:nt,args:{...n,size:a[1]}},O={render:ot,args:{...n,size:a[1]}};var _,Z,N;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
    ...headerDescriptionProperties
  }
}`,...(N=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:N.source}}};var G,H,F;b.parameters={...b.parameters,docs:{...(G=b.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
    ...headerDescriptionProperties,
...
}`,...(se=(de=D.parameters)==null?void 0:de.docs)==null?void 0:se.source}}};var ce,me,ge;f.parameters={...f.parameters,docs:{...(ce=f.parameters)==null?void 0:ce.docs,source:{originalSource:`{
...
}`,...(ge=(me=f.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};var pe,ue,be;E.parameters={...E.parameters,docs:{...(pe=E.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(We=(Be=L.parameters)==null?void 0:Be.docs)==null?void 0:We.source}}};var _e,Ze,Ne;O.parameters={...O.parameters,docs:{...(_e=O.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  render: renderDialogWithTextarea,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[1]
  }
}`,...(Ne=(Ze=O.parameters)==null?void 0:Ze.docs)==null?void 0:Ne.source}}};const mt=["Example","WithoutBackdrop","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithinOtherOverlays","DialogWithIframe","DialogWithList","DialogWithTextarea"];export{C as DialogWithIframe,L as DialogWithList,O as DialogWithTextarea,k as DialogWithinDialog,z as DialogWithinOtherOverlays,u as Example,T as MountUnmount,$ as WithPopover,b as WithoutBackdrop,A as WithoutTriggerElement,mt as __namedExportsOrder,ct as default,S as fullscreen,y as large,v as medium,h as small,E as withCustomHeader,f as withSaveCancelButtons,x as withoutHeader,D as withoutHeaderOrFooter,I as xlarge};
