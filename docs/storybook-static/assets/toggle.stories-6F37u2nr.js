import{aG as x,Y as K,L as J,M as Q,aV as y,k as g,t as i}from"./iframe-CmSvbQSS.js";import{c as X,s as ee}from"./commonArgTypes-BG7EqI50.js";import{h as te,a as S}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,oe=e=>g`
  <div role="main">
    <mdc-toggle
      name="${i(e.name)}"
      value="${i(e.value)}"
...
`,se={title:"Components/toggle",tags:["autodocs"],component:"mdc-toggle",render:oe,argTypes:{size:{control:"inline-radio",options:Object.values(x)},checked:{control:"boolean"},disabled:{control:"boolean"},readonly:{control:"boolean"},"soft-disabled":{control:"boolean"},"control-type":{control:"select",options:[void 0,...K]},label:{control:"text"},"help-text":{control:"text"},"auto-focus-on-mount":{control:"boolean"},required:{control:"boolean"},name:{control:"text"},value:{control:"text"},"data-aria-label":{control:"text",description:"Aria label for the toggle component. Required for accessibility."},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(J)},"toggletip-strategy":{control:"select",options:Object.values(Q)},"info-icon-aria-label":{control:"text"},...te(["help-text-type","id","validation-message","validity","willValidate"]),...X,...ee}},a={args:{name:"toggleName",value:"toggleValue",label:"Toggle label",checked:!1,size:y.SIZE,disabled:!1,readonly:!1,"soft-disabled":!1,"help-text":""}},d={args:{...a.args,size:x.DEFAULT}},m={args:{...a.args,size:x.COMPACT}},u={args:{...a.args,"help-text":"helper text"}},p={args:{size:y.SIZE},render:e=>g`
      <div role="main">
    ...
    `,...S()},f={render:e=>{const c=(t,s)=>{const l=t.querySelector('mdc-toggle[name="toggleName"]'),{checked:T}=l;return s.required&&!T?(l.setAttribute("help-text","Please agree to the terms to continue"),l.setAttribute("help-text-type","error"),!1):(l.setAttribute("help-text","Looks good!"),l.setAttribute("help-text-type","success"),!0)};return g`
      <div role="main">
    ...
    `},args:{size:y.SIZE,required:!0,"help-text":"","help-text-type":"default"},...S()},v={render:()=>g`
    ...
    `,...S()};var E,z,A;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    name: 'toggleName',
    value: 'toggleValue',
    label: 'Toggle label',
...
}`,...(w=(F=m.parameters)==null?void 0:F.docs)==null?void 0:w.source}}};var L,V,q;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    'help-text': 'helper text'
  }
}`,...(q=(V=u.parameters)==null?void 0:V.docs)==null?void 0:q.source}}};var I,N,O;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE
  },
  render: args => html\`
    ...
    \`
}`,...(O=(N=p.parameters)==null?void 0:N.docs)==null?void 0:O.source}}};var U,R,_;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    label: undefined,
    'data-aria-label': 'This is a toggle with no label'
  }
}`,...(_=(R=h.parameters)==null?void 0:R.docs)==null?void 0:_.source}}};var M,Z,H;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE
  },
  render: args => {
  ...
  ...hideAllControls()
}`,...(H=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:H.source}}};var W,P,G;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
  ...
  ...hideAllControls()
}`,...(G=(P=f.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var j,Y,B;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
