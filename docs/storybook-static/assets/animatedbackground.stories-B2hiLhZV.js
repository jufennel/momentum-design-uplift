import{P as E,c as M,k}from"./iframe-B8woZv37.js";import{c as $,s as A}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,P="720px",S="1280px",n=e=>s=>{const t=s.currentTarget.closest("[data-demo-root]"),d=t==null?void 0:t.querySelector("mdc-animatedbackground");d==null||d[e]()},I=e=>{const s=window.matchMedia.bind(window);return window.matchMedia=t=>t.includes("prefers-reduced-motion")?{matches:!0,media:t,addEventListener:()=>{},removeEventListener:()=>{},dispatchEvent:()=>!0,onchange:null}:s(t),e()},w=e=>k`
  <div
