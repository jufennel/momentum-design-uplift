import{Y as ge,N as i,Z as ye,L as T,M as O,k as t,R as ue,t as o}from"./iframe-2vtXQJPx.js";import{c as fe,s as Se}from"./commonArgTypes-BG7EqI50.js";import{h as Ae,a as m,d as he}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";var D=Object.freeze,we=Object.defineProperty,Ce=(e,r)=>D(we(e,"raw",{value:D(e.slice())})),R;const{action:c}=__STORYBOOK_MODULE_ACTIONS__,s=e=>t`<div style="width: 25rem; height: 100%; display: flex; align-items: center;" role="${ue.MAIN}">
    ${e}
    ...
    >
      ${e.children}
    </mdc-combobox>`),Oe={title:"Components/combobox",tags:["autodocs"],component:"mdc-combobox",render:ve,parameters:{badges:["stable"]},argTypes:{"auto-focus-on-mount":{control:"boolean"},"backdrop-append-to":{control:"text"},boundary:{control:"text"},"control-type":{control:"select",options:ge},"data-aria-label":{control:"text"},disabled:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",options:Object.values(i)},"info-icon-aria-label":{control:"text"},label:{control:"text"},name:{control:"text"},filter:{control:"select",options:Object.values(ye)},"no-result-text":{control:"text"},placeholder:{control:"text"},placement:{control:"select",options:[T.BOTTOM_START,T.TOP_START]},"popover-z-index":{control:"number"},readonly:{control:"boolean"},required:{control:"boolean"},strategy:{control:"select",options:Object.values(O)},value:{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(T)},"toggletip-strategy":{control:"select",options:Object.values(O)},"validation-message":{control:"text"},"invalid-custom-value-text":{control:"text"},...Ae(["children","controlTypeProviderContext","itemsStore","soft-disabled","name","validity","value","willValidate"]),...fe,...Se}},b={args:{label:"Top Countries",name:"country","help-text":"Select a country","help-text-type":i.DEFAULT,disabled:!1,readonly:!1,"no-result-text":"No results found",placeholder:"Start typing","data-aria-label":"Select a country","info-icon-aria-label":"Required icon label",placement:T.BOTTOM_START,"invalid-custom-value-text":"Custom values are not allowed",children:t`
      <mdc-selectlistbox>
...
}`,...(K=(G=g.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var J,Z,Q;y.parameters={...y.parameters,docs:{...(J=y.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => wrapper(html\`
      <mdc-combobox
        placeholder="Type a color"
        label="Select one color"
    ...
    \`),
  ...hideAllControls()
}`,...(Q=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:Q.source}}};var X,ee,oe;f.parameters={...f.parameters,docs:{...(X=f.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => {
...
}`,...(be=(pe=C.parameters)==null?void 0:pe.docs)==null?void 0:be.source}}};const De=["Example","AllVariants","ComboboxWithControlled","ComboboxWithOptionGroups","ComboboxWithDisabledOptions","ComboboxWithSelectedValue","ComboboxWithLongOptionText","ComboboxWithForm","ComboboxWithHelpTextValidation","ComboboxWithNoFilter","ComboboxInsidePopover","ComboboxWithMultiplePopovers"];export{u as AllVariants,w as ComboboxInsidePopover,h as ComboboxWithControlled,x as ComboboxWithDisabledOptions,f as ComboboxWithForm,S as ComboboxWithHelpTextValidation,y as ComboboxWithLongOptionText,C as ComboboxWithMultiplePopovers,A as ComboboxWithNoFilter,v as ComboboxWithOptionGroups,g as ComboboxWithSelectedValue,b as Example,De as __namedExportsOrder,Oe as default};
