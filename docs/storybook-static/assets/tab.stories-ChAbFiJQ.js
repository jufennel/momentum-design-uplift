import{aN as D,aO as s,k as f,t as a,E as G,R as c}from"./iframe-Ctm5TQtB.js";import{h as u,r as x,a as V}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,o=e=>f`<div role="tablist">
    <mdc-tab
      @click="${t("onclick")}"
      @keydown="${t("onkeydown")}"
      @keyup="${t("onkeyup")}"
  ...
  `,...V()};var v,g,y;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render,
  args: {
    ...defaultArgs
  }
...
}`,...(C=(B=m.parameters)==null?void 0:B.docs)==null?void 0:C.source}}};var E,_,R;b.parameters={...b.parameters,docs:{...(E=b.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(R=(_=b.parameters)==null?void 0:_.docs)==null?void 0:R.source}}};var w,N,z;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => html\`
  ...
  \`,
  ...hideAllControls()
}`,...(z=(N=p.parameters)==null?void 0:N.docs)==null?void 0:z.source}}};const U=["Example","GlassTab","LineTab","PillTab","IconOnlyTab","CustomPrefixSlot","TabWithSlots"];export{b as CustomPrefixSlot,r as Example,i as GlassTab,m as IconOnlyTab,d as LineTab,l as PillTab,p as TabWithSlots,U as __namedExportsOrder,K as default};
