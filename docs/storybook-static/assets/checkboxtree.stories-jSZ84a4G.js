import{U as o,M as A,N as f,k as n,t as c}from"./iframe-Cu7nV89y.js";import{c as S,s as T}from"./commonArgTypes-BG7EqI50.js";import{h as E}from"./utils-B5QUENNQ.js";import"./preload-helper-DvzR3F7X.js";const v=n`
...
`,C={title:"Widgets/checkboxtree",tags:["autodocs"],component:"mdc-checkboxtree",render:L,argTypes:{label:{control:"text"},"help-text":{control:"text"},"help-text-type":{control:"select",options:Object.values(o)},required:{control:"boolean"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(A)},"toggletip-strategy":{control:"select",options:Object.values(f)},"info-icon-aria-label":{control:"text"},children:{control:!1,description:"Any content. To let an mdc-checkbox control a descendant mdc-checkboxtree, place the tree immediately after the checkbox."},...E(["disabled","readonly","soft-disabled"]),...S,...T}},t={args:{label:"Select your Avengers team","help-text":"Select all that apply.","help-text-type":o.DEFAULT,required:!0,"toggletip-text":"Parent selections apply to every available descendant.","toggletip-placement":A.TOP,"toggletip-strategy":f.ABSOLUTE,"info-icon-aria-label":"About team selection",children:v}},a={args:{label:"Notification preferences","help-text":"Choose which work notifications you receive.","help-text-type":o.DEFAULT,children:n`
      <mdc-checkbox
    ...
    `}},l={args:{...t.args,"help-text":"You must select at least one team member.","help-text-type":o.ERROR,"toggletip-text":void 0}},r={args:{label:"Select teams for the international incident response program","help-text":"Choose every regional team that should receive alerts.","help-text-type":o.DEFAULT,children:n`
    ...
    `}};var d,i,h;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(h=(i=t.parameters)==null?void 0:i.docs)==null?void 0:h.source}}};var m,s,b;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
...
}`,...(b=(s=a.parameters)==null?void 0:s.docs)==null?void 0:b.source}}};var x,p,k;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    ...Example.args,
...
}`,...(y=(u=r.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};const N=["Example","CheckboxStates","Error","LongAndMultilingualContent"];export{a as CheckboxStates,l as Error,t as Example,r as LongAndMultilingualContent,N as __namedExportsOrder,C as default};
