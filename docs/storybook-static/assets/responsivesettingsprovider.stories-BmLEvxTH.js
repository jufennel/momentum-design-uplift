import{at as l,au as u,k as n}from"./iframe-2vtXQJPx.js";import{h as s}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const g=e=>n`
...
`,h={title:"Providers/Responsive Settings Provider",tags:["autodocs"],component:"mdc-responsivesettingsprovider",render:g,argTypes:{"force-fullscreen-dialog":{control:"boolean"},"popover-positioning":{control:"select",options:l},media:{control:"select",options:u},...s(["Context"])}},t={render:e=>{const d=()=>document.getElementById("dialog-id").removeAttribute("visible"),r=()=>document.getElementById("dialog-id").toggleAttribute("visible"),c=()=>document.getElementById("announcement-id").removeAttribute("visible"),a=()=>document.getElementById("announcement-id").toggleAttribute("visible");return n`
      <mdc-responsivesettingsprovider
        ?force-fullscreen-dialog="${e["force-fullscreen-dialog"]}"
        popover-positioning="${e["popover-positioning"]}"
        media="${e.media}"
...
}`,...(m=(o=t.parameters)==null?void 0:o.docs)==null?void 0:m.source}}};const f=["Example"];export{t as Example,f as __namedExportsOrder,h as default};
