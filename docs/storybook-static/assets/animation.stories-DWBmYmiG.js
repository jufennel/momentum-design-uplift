import{d as h,e as m,k as t,B as T,f as g,g as U}from"./iframe-2vtXQJPx.js";import{c as N,s as w}from"./commonArgTypes-BG7EqI50.js";import{a as x}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,E=o=>t` <mdc-animation
    @load="${a("load")}"
    @complete="${a("complete")}"
    @error="${a("error")}"
    name="${o.name}"
