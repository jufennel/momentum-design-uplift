import{aj as Q,ak as V,k as e}from"./iframe-Ctm5TQtB.js";import{c as X,s as Z}from"./commonArgTypes-BG7EqI50.js";import{h as ee,b as te,a as n}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,m="Menu Item",r=t=>e`<div role="menu" style="width: 20rem;">${t}</div>`,ne=t=>r(e` <mdc-menuitem
      @click="${i("onclick")}"
      @keydown="${i("onkeydown")}"
      @keyup="${i("onkeyup")}"
      @focus="${i("onfocus")}"
    ...
    ></mdc-menuitem>`),le={title:"Components/menupopover/menuitem",tags:["autodocs"],component:"mdc-menuitem",render:ne,argTypes:{label:{control:"text"},"secondary-label":{control:"text"},"side-header-text":{control:"text"},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},"tertiary-label":{control:"text"},"subline-text":{control:"text"},"arrow-position":{control:"select",options:Object.values(Q)},"arrow-direction":{control:"select",options:Object.values(V)},...ee(["variant","--mdc-listitem-background-color-active","--mdc-listitem-background-color-hover","--mdc-listitem-default-background-color","--mdc-listitem-primary-label-color","--mdc-listitem-secondary-label-color","--mdc-listitem-disabled-color","--mdc-listitem-column-gap","--mdc-listitem-padding-left-and-right","default"]),...te(["leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","click","keydown","keyup","focus"]),...X,...Z}},o={args:{label:m,"secondary-label":"This is a secondary Label","side-header-text":"","tertiary-label":"","subline-text":"",disabled:!1}},l={render:()=>r(e`
    ...
    `),...n()},b={render:()=>r(e` <mdc-menuitem label="${m}" side-header-text="##"></mdc-menuitem> `),...n()},p={render:()=>r(e` <mdc-menuitem label="${m}" arrow-position="trailing"></mdc-menuitem> `),...n()},h={render:()=>r(e` <mdc-menuitem label="${m}" arrow-position="leading"></mdc-menuitem> `),...n()},g={render:()=>e`
  ...
  `,...n()};var y,v,w;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    label,
...
}`,...(w=(v=o.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var x,I,$;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...($=(I=l.parameters)==null?void 0:I.docs)==null?void 0:$.source}}};var f,S,W;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(R=(N=u.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var E,F,j;b.parameters={...b.parameters,docs:{...(E=b.parameters)==null?void 0:E.docs,source:{originalSource:'{\n  render: () => wrapWithDiv(html` <mdc-menuitem label="${label}" side-header-text="##"></mdc-menuitem> `),\n  ...hideAllControls()\n}',...(j=(F=b.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var H,K,P;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:'{\n  render: () => wrapWithDiv(html` <mdc-menuitem label="${label}" arrow-position="trailing"></mdc-menuitem> `),\n  ...hideAllControls()\n}',...(P=(K=p.parameters)==null?void 0:K.docs)==null?void 0:P.source}}};var U,Y,q;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:'{\n  render: () => wrapWithDiv(html` <mdc-menuitem label="${label}" arrow-position="leading"></mdc-menuitem> `),\n  ...hideAllControls()\n}',...(q=(Y=h.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};var z,G,J;g.parameters={...g.parameters,docs:{...(z=g.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => html\`
    <div role="menu" style="width: 15rem; height: 10rem;">
      <mdc-menuitem label="Hover on this menu item" id="menuitem-1">
        <mdc-icon length-unit="rem" slot="leading-controls" name="placeholder-bold"></mdc-icon>
  ...
  \`,
  ...hideAllControls()
}`,...(J=(G=g.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const ae=["Example","ListOfMenuItems","MenuItemWithLeadingIcon","MenuItemWithTrailingIcon","MenuItemWithBadge","MenuItemWithBadgeIcon","MenuItemWithBadgeCounter","MenuItemWithSideText","MenuItemWithTrailingArrow","MenuItemWithLeadingArrow","MenuItemWithTooltip"];export{o as Example,l as ListOfMenuItems,c as MenuItemWithBadge,u as MenuItemWithBadgeCounter,s as MenuItemWithBadgeIcon,h as MenuItemWithLeadingArrow,a as MenuItemWithLeadingIcon,b as MenuItemWithSideText,g as MenuItemWithTooltip,p as MenuItemWithTrailingArrow,d as MenuItemWithTrailingIcon,ae as __namedExportsOrder,le as default};
