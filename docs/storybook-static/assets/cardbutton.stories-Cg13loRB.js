import{G as V,O as T,h as g,z as B,H as t,k as A,t as a}from"./iframe-CmSvbQSS.js";import{i as _}from"./manifest-CNQCgfOm.js";import{i}from"./imageFixtures-CD4avj2q.js";import{c as k,s as z}from"./commonArgTypes-BG7EqI50.js";import{h as H}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,j=e=>A` <mdc-cardbutton
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @keyup="${o("onkeyup")}"
    @focus="${o("onfocus")}"
...
}`,...(C=(U=m.parameters)==null?void 0:U.docs)==null?void 0:C.source}}};var D,G,M;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': imageFixtures.card,
...
}`,...(M=(G=u.parameters)==null?void 0:G.docs)==null?void 0:M.source}}};const Q=["Example","HorizontalCard","CardWithoutImage","CardWithoutHeader","CardWithoutBody","ContentBeforeBody","ContentAfterBody"];export{d as CardWithoutBody,c as CardWithoutHeader,s as CardWithoutImage,u as ContentAfterBody,m as ContentBeforeBody,r as Example,l as HorizontalCard,Q as __namedExportsOrder,Y as default};
