import{k as i,Q as r,af as s,ag as lt,ah as at}from"./iframe-Ctm5TQtB.js";import{c as st,s as ct}from"./commonArgTypes-BG7EqI50.js";import{h as ot}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:e}=__STORYBOOK_MODULE_ACTIONS__,o=["Maria Simpson","Diana Rees","Fiona Wallace","Abigail Reid","Theresa Miller","Andrea Wright","Natalie Hunter","Bernadette Carr","Samantha Robertson","Deirdre Clark"],nt=t=>i` <mdc-list
  ...
  >
    ...
    ${r(o,l=>i`<mdc-listitem @click="${e("onclick")}" label="${l}" variant="${s.INSET_PILL}">
  ...
  </mdc-list>`,bt={title:"Components/list",tags:["autodocs"],component:"mdc-list",render:nt,argTypes:{textPassedToListHeader:{control:"text",description:"Text to be rendered in the list header component. This is a control in storybook only."},"aria-label":{control:"text"},loop:{control:"select",options:["true","false"],table:{defaultValue:{summary:"true"}}},orientation:{control:"select",options:["vertical","horizontal"],table:{defaultValue:{summary:"vertical"}}},...ot(["itemsStore"]),...st,...ct}},d={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants",orientation:"vertical"}},u={render:t=>i`
  ...
  `,args:{textPassedToListHeader:"Scrollable Participants List","aria-label":"View all participants"}},p={render:t=>{const l=a=>{const n=a.target.closest("mdc-listitem");n&&n.remove()},m=()=>{var c;const a=[...document.querySelector("mdc-list").querySelectorAll("mdc-listitem")];(c=a[a.length-1])==null||c.remove()};return i`
      <mdc-list aria-label="${t["aria-label"]}">
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${r(o,a=>i`<mdc-listitem @click="${e("onclick")}" label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
    ...
    `}},g={args:{textPassedToListHeader:"Participants List","aria-label":"View all participants","initial-focus":o.length-1}},h={render:t=>{const l=at(),m=()=>{var T,I;const a=document.createElement("mdc-listitem");a.setAttribute("variant",s.INSET_PILL),a.setAttribute("label",`List Item ${(((T=l.value)==null?void 0:T.children.length)||0)+1}`);const c=document.createElement("mdc-button");c.setAttribute("slot","trailing-controls"),c.textContent="Action";const n=document.createElement("mdc-button");n.setAttribute("slot","trailing-controls"),n.textContent="Action 2",a.append(c,n),(I=l.value)==null||I.append(a)};return i`
      <mdc-list aria-label="${t["aria-label"]}" ${lt(l)}>
        ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
        ${r(o.slice(0,4),a=>i`<mdc-listitem label="${a}" variant="${s.INSET_PILL}">
              <mdc-avatar
                slot="leading-controls"
                initials="${[a.split(" ")[0][0],a.split(" ")[1][0]].join("")}"
              ></mdc-avatar>
    ...
    >
      ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
      ${r(new Array(5).fill(0).map(()=>[...o]).flat(),l=>l,l=>i`<mdc-listitem @click="${e("onclick")}" label="${l}" variant="${s.INSET_PILL}">
            <mdc-checkbox slot="leading-controls" data-aria-label="mock label"></mdc-checkbox>
            <mdc-avatar
              slot="leading-controls"
              initials="${[l.split(" ")[0][0],l.split(" ")[1][0]].join("")}"
  ...
  `},$={parameters:{docs:{description:{story:i`<mdc-text tagname="p" type="body-large-bold">Horizontal List Orientation</mdc-text>
    ...
    >
      ${t.textPassedToListHeader?i`<mdc-listheader slot="list-header" header-text="${t.textPassedToListHeader}"></mdc-listheader>`:""}
      ${r(o.slice(0,5),l=>i`<mdc-listitem
            @click="${e("onclick")}"
            label="${l}"
  ...
  `,args:{textPassedToListHeader:"Scrollable Participants List","aria-label":"View all participants"}};var y,P,E;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    textPassedToListHeader: 'Participants List',
    'aria-label': 'View all participants',
    orientation: 'vertical'
  }
}`,...(E=(P=d.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var f,S,N;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => html\`
...
}`,...(N=(S=u.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};var A,w,q;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => html\`
...
}`,...(q=(w=b.parameters)==null?void 0:w.docs)==null?void 0:q.source}}};var R,H,_;p.parameters={...p.parameters,docs:{...(R=p.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: args => {
...
}`,...(_=(H=p.parameters)==null?void 0:H.docs)==null?void 0:_.source}}};var V,M,C;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    textPassedToListHeader: 'Participants List',
    'aria-label': 'View all participants',
...
}`,...(it=(et=x.parameters)==null?void 0:et.docs)==null?void 0:it.source}}};const pt=["Example","ListWithDivider","ScrollableListWithSelect","ListWithRemovalElements","InitialFocusAtBottom","ExpandingList","ScrollingList","ListWithInteractiveElements","HorizontalOrientation","NestedList","ScrollableListWithLongListItems"];export{d as Example,h as ExpandingList,$ as HorizontalOrientation,g as InitialFocusAtBottom,u as ListWithDivider,L as ListWithInteractiveElements,p as ListWithRemovalElements,k as NestedList,x as ScrollableListWithLongListItems,b as ScrollableListWithSelect,v as ScrollingList,pt as __namedExportsOrder,bt as default};
