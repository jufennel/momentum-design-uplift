import{b9 as a,ba as m,bb as i,k as d}from"./iframe-BRzdycIC.js";import"./preload-helper-C1FmrZbK.js";class u extends a{constructor(){super(...arguments),this.controlTypeProviderContext=m.consume({host:this,context:i.Context})}render(){return d` <p>Context.value: ${this.controlTypeProviderContext.value}</p> `}}u.register("mdc-subcomponent-control-type");const y=r=>d`
