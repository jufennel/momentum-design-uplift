import{k as i,Q as T}from"./iframe-Bzl5oY3a.js";import{c as z,s as C}from"./commonArgTypes-BG7EqI50.js";import{h as $}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,k=[{tabId:"messages",text:"Messages",iconName:"chat-regular"},{tabId:"favorites",text:"Favorites",iconName:"favorite-regular"},{tabId:"contacts",text:"Contacts",iconName:"contact-card-regular"},{tabId:"meetings",text:"Meetings",iconName:"meetings-regular"},{tabId:"calls",text:"Calls",iconName:"handset-regular"},{tabId:"voicemail",text:"Voicemail",iconName:"voicemail-regular"},{tabId:"settings",text:"Settings",iconName:"settings-regular"}],N=t=>i`<mdc-verticaltablist
