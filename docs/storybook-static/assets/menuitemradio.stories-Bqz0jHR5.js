import{am as s,Z as b,k as c,t as h}from"./iframe-Dzfa47RN.js";import{c as p,s as k}from"./commonArgTypes-BG7EqI50.js";import{h as g,a as y}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,u=e=>c`<div role="menu" style="width: 25rem;">${e}</div>`,v=e=>u(c` <mdc-menuitemradio
      @change="${a("onchange")}"
      @click="${a("onclick")}"
      @focus="${a("onfocus")}"
      ?checked="${e.checked}"
