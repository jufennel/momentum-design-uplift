import{k as p,R as u}from"./iframe-2vtXQJPx.js";import{a as g}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,c="motion-demo-menu-trigger",s="motion-demo-dialog-trigger",n="motion-demo-dialog",h=t=>{var o;return(o=document.querySelector("body.sb-show-main"))==null||o.classList.remove("mds-motion","mds-animation"),t()},v=()=>{var t;(t=document.getElementById(n))==null||t.setAttribute("visible","")},d=()=>{var t;(t=document.getElementById(n))==null||t.removeAttribute("visible")},D=(t,{updateArgs:o})=>{const b=t.motionEnabled?"full":"reduce";return p`
